...
TALOS_RPI5_PHASE_STACK_TO_TEXT_RESET_DIAGNOSTIC=1 \
...
IMG_FILE="target/aarch64-talos-rpi5-bcm2712/debug/kernel_2712-phase-stack-to-text-reset-diagnostic.img"
