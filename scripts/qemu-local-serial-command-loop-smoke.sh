        ...
        case "$line" in
            *"$LABEL: ready command=10"*)
                if [ "$sent" -eq 10 ] && [ "$SHELL_WAITPID_SMOKE" -eq 1 ]; then
                    ...
                    sent=11
                elif [ "$sent" -eq 10 ] && { [ "$SHELL_STDOUT_SMOKE" -eq 1 ] || [ "$SHELL_STDIN_SMOKE" -eq 1 ]; }; then
            ...
            *"$LABEL: ready command=11"*)
                if [ "$sent" -eq 11 ] && [ "$SHELL_WAITPID_SMOKE" -eq 1 ]; then
                    ...
                    sent=12
                elif [ "$sent" -eq 11 ] && { [ "$SHELL_STDOUT_SMOKE" -eq 1 ] || [ "$SHELL_STDIN_SMOKE" -eq 1 ]; }; then
                    printf 'exec missing\r' >&3
                    sent=12
            ...
            *"$LABEL: ready command=12"*)
                if [ "$sent" -eq 12 ] && [ "$SHELL_WAITPID_SMOKE" -eq 1 ]; then
                    ...
                    printf 'exec /bin\r' >&3
                    sent=13
                elif [ "$sent" -eq 12 ] && { [ "$SHELL_STDOUT_SMOKE" -eq 1 ] || [ "$SHELL_STDIN_SMOKE" -eq 1 ]; }; then
                    printf 'exec bin/status42\r' >&3
                    sent=13
                fi
                ;;
            *"$LABEL: ready command=13"*)
                if [ "$sent" -eq 13 ] && [ "$SHELL_WAITPID_SMOKE" -eq 1 ]; then
                    ...
                    printf 'exec /etc/banner.txt\r' >&3
                    sent=14
                elif [ "$sent" -eq 13 ] && { [ "$SHELL_STDOUT_SMOKE" -eq 1 ] || [ "$SHELL_STDIN_SMOKE" -eq 1 ]; }; then
                    printf 'exec /bin\r' >&3
                    sent=14
                fi
                ;;
            *"$LABEL: ready command=14"*)
                if [ "$sent" -eq 14 ] && [ "$SHELL_WAITPID_SMOKE" -eq 1 ]; then
                    ...
                    printf 'exec /empty\r' >&3
                    sent=15
                elif [ "$sent" -eq 14 ] && { [ "$SHELL_STDOUT_SMOKE" -eq 1 ] || [ "$SHELL_STDIN_SMOKE" -eq 1 ]; }; then
                    printf 'exec /etc/banner.txt\r' >&3
                    sent=15
                fi
                ;;
            *"$LABEL: ready command=15"*)
                if [ "$sent" -eq 15 ] && [ "$SHELL_WAITPID_SMOKE" -eq 1 ]; then
                    ...
                    printf 'exec /bin/status42 *\r' >&3
                    sent=16
                elif [ "$sent" -eq 15 ] && { [ "$SHELL_STDOUT_SMOKE" -eq 1 ] || [ "$SHELL_STDIN_SMOKE" -eq 1 ]; }; then
                    printf 'exec /empty\r' >&3
                    sent=16
                fi
                ;;
            *"$LABEL: ready command=16"*)
                if [ "$sent" -eq 16 ] && [ "$SHELL_WAITPID_SMOKE" -eq 1 ]; then
                    ...
                    printf 'cat /etc/banner.txt\r' >&3
                    sent=17
                elif [ "$sent" -eq 16 ] && { [ "$SHELL_STDOUT_SMOKE" -eq 1 ] || [ "$SHELL_STDIN_SMOKE" -eq 1 ]; }; then
                    printf 'exec /bin/status42 *\r' >&3
                    sent=17
                fi
                ;;
            *"$LABEL: ready command=17"*)
                if [ "$sent" -eq 17 ] && [ "$SHELL_WAITPID_SMOKE" -eq 1 ]; then
                    printf 'cat /etc/banner.txt\r' >&3
                    sent=18
                elif [ "$sent" -eq 17 ] && { [ "$SHELL_STDOUT_SMOKE" -eq 1 ] || [ "$SHELL_STDIN_SMOKE" -eq 1 ]; }; then
                    printf 'cat /etc/banner.txt\r' >&3
                    sent=18
                fi
                ;;
            ...
            *"$LABEL: ready command=4"*)
                if [ "$sent" -eq 4 ]; then
                    if [ "$LINE_KILL_SMOKE" -eq 1 ]; then
                        ...
                        printf 'waitpid\r' >&3
                    elif [ "$SHELL_STDOUT_SMOKE" -eq 1 ] || [ "$SHELL_STDIN_SMOKE" -eq 1 ]; then
                        printf 'waitpid\r' >&3
                    elif [ "$SHELL_VFS_EXEC_SMOKE" -eq 1 ]; then
            ...
            *"$LABEL: ready command=9"*)
                if [ "$sent" -eq 9 ] && [ "$SHELL_WAITPID_SMOKE" -eq 1 ]; then
                    ...
                    printf 'laststatus\r' >&3
                    sent=10
                elif [ "$sent" -eq 9 ] && { [ "$SHELL_STDOUT_SMOKE" -eq 1 ] || [ "$SHELL_STDIN_SMOKE" -eq 1 ]; }; then
                    printf 'exec zero\r' >&3
                    sent=10
...
if [ "$PWD_COMMAND_SMOKE" -eq 1 ] || [ "$LS_ROOT_SMOKE" -eq 1 ] || [ "$LS_BIN_SMOKE" -eq 1 ] || [ "$CAT_BANNER_SMOKE" -eq 1 ] || [ "$CAT_CWD_SMOKE" -eq 1 ] || [ "$SHELL_VFS_EXEC_SMOKE" -eq 1 ] || [ "$SHELL_LITERAL_ARGV_SMOKE" -eq 1 ] || [ "$SHELL_PATH_LOOKUP_SMOKE" -eq 1 ] || [ "$SHELL_STDOUT_SMOKE" -eq 1 ] || [ "$SHELL_STDIN_SMOKE" -eq 1 ] || [ "$SHELL_WAITPID_SMOKE" -eq 1 ] || [ "$CD_FIXED_DIRS_SMOKE" -eq 1 ] || [ "$LS_CWD_SMOKE" -eq 1 ] || [ "$LITERAL_ECHO_SMOKE" -eq 1 ] || [ "$ECHO_COMMAND_SMOKE" -eq 1 ]; then
    grep -q "$LABEL: ready command=5" "$LOG_FILE"
fi
if [ "$PWD_COMMAND_SMOKE" -eq 1 ] || [ "$LS_BIN_SMOKE" -eq 1 ] || [ "$CAT_BANNER_SMOKE" -eq 1 ] || [ "$CAT_CWD_SMOKE" -eq 1 ] || [ "$SHELL_VFS_EXEC_SMOKE" -eq 1 ] || [ "$SHELL_LITERAL_ARGV_SMOKE" -eq 1 ] || [ "$SHELL_PATH_LOOKUP_SMOKE" -eq 1 ] || [ "$SHELL_STDOUT_SMOKE" -eq 1 ] || [ "$SHELL_STDIN_SMOKE" -eq 1 ] || [ "$SHELL_WAITPID_SMOKE" -eq 1 ] || [ "$CD_FIXED_DIRS_SMOKE" -eq 1 ] || [ "$LS_CWD_SMOKE" -eq 1 ]; then
...
if [ "$SHELL_STDOUT_SMOKE" -eq 1 ] || [ "$SHELL_STDIN_SMOKE" -eq 1 ]; then
    grep -q "$LABEL: ready command=7" "$LOG_FILE"
    grep -q "$LABEL: ready command=8" "$LOG_FILE"
    grep -q "$LABEL: ready command=9" "$LOG_FILE"
    grep -q "$LABEL: ready command=10" "$LOG_FILE"
...
if [ "$LINE_EDITING_SMOKE" -eq 1 ]; then
    ...
    grep -q "^Talos userspace stdin fixture read: talos-fd0" "$LOG_FILE"
    ...
    grep -q "talos: exec-stdin fd=0x0000000000000000 bytes=0x000000000000000a return=0x000000000000000a stdout-fd=0x0000000000000001 stdout-bytes=0x000000000000002f stdout-return=0x000000000000002f source=userspace-talos-read+userspace-talos-write" "$LOG_FILE"
    ...
    grep -q "$LABEL: dispatch command=8 status=handled responses=5" "$LOG_FILE"
    grep -q "talos> cd /" "$LOG_FILE"
    ...
    grep -q "$LABEL: dispatch command=3 status=handled responses=5" "$LOG_FILE"
    grep -q "talos> ls /" "$LOG_FILE"
    grep -q "^bin" "$LOG_FILE"
    grep -q "^dir" "$LOG_FILE"
    grep -q "^empty" "$LOG_FILE"
