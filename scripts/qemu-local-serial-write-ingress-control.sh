...
grep -q "qemu-local-literal-echo: start command-count=6 backend=runtime-console0/qemu-virt-pl011 input=fd0/runtime-console0/tty-canonical-lite builtins=.* descriptor-backed-input=true descriptor-backed-output=true" "$EVIDENCE_LOG"
grep -q "generated-root-manifest-read+generated-root-executable-vfs-exec" "$EVIDENCE_LOG"
