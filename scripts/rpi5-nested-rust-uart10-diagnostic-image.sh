...
TALOS_RPI5_PHASE_CONTINUE_DIAGNOSTIC=1 \
TALOS_RPI5_RUST_UART10_DIAGNOSTIC=1 \
...
IMG_FILE="target/aarch64-talos-rpi5-bcm2712/debug/kernel_2712-nested-rust-uart10-diagnostic.img"
