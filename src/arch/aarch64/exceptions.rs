...
pub extern "C" fn rust_exception_handler(
    ...
    if crate::target::rpi5::handle_close_syscall_proof_exception(
        esr,
        elr,
        far,
        vector,
    ...
    if crate::target::rpi5::handle_dup_syscall_proof_exception(
        esr,
        elr,
        far,
        vector,
...
pub extern "C" fn rust_exception_handler(
    ...
    if crate::target::qemu_virt::handle_close_syscall_smoke_exception(
        esr,
        elr,
        far,
        vector,
    ...
    if crate::target::qemu_virt::handle_dup_syscall_smoke_exception(
        esr,
        elr,
        far,
        vector,
