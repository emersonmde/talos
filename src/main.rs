...
pub extern "C" fn rust_entry(dtb_pa: usize) -> ! {
    ...
    {
        let _ = dtb_pa;
        target::rpi5::run_ssh_service_smoltcp_rust_entry_marker_loop();
    }
    ...
    {
        let _ = dtb_pa;
        target::rpi5::run_rp1_ethernet_bcm54213pe_autoneg_convergence_candidate();
    }
    ...
    {
        let _ = dtb_pa;
        target::rpi5::run_rp1_ethernet_bcm54213pe_autoneg_convergence_no_mdio_control();
    }
    ...
    {
        let _ = dtb_pa;
        target::rpi5::run_rp1_ethernet_bcm54213pe_tx_selected_read_discriminator_candidate();
    }
    ...
    {
        let _ = dtb_pa;
        target::rpi5::run_rp1_ethernet_bcm54213pe_tx_selected_read_discriminator_no_mdio_control();
    }
    ...
    {
        let _ = dtb_pa;
        target::rpi5::run_rp1_ethernet_bcm54213pe_master_mode_autoneg_candidate();
    }
    ...
    {
        let _ = dtb_pa;
        target::rpi5::run_rp1_ethernet_bcm54213pe_master_mode_autoneg_no_mdio_control();
    }
