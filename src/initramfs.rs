...
pub(crate) const PHASE10_STDIN_DEV_NULL_EOF_STDOUT: &[u8] =
    b"Talos userspace stdin fixture read-result: null-source-eof/no-data\n";
pub(crate) const PHASE10_STDIN_PIPE_EOF_STDOUT: &[u8] =
    b"Talos userspace stdin fixture read-result: pipe-eof/no-data\n";
...
pub(crate) const PHASE12_SOCKDIAG_PATH: &[u8] = b"/bin/sockdiag";
pub(crate) const PHASE12_SOCKDIAG_BYTES: &[u8] = &PHASE12_SOCKDIAG_ELF_BYTES;
...
const PHASE12_SOCKDIAG_INDEX: usize = 11;
const PHASE8_EMPTY_INDEX: usize = 12;
const PHASE8_DIR_INDEX: usize = 13;
const PHASE8_NESTED_INDEX: usize = 14;
const GENERATED_ROOT_DIR_INDEX: usize = 15;
const GENERATED_ROOT_FILE_INDEX: usize = 16;
const GENERATED_ROOT_EXEC_INDEX: usize = 17;
...
static PHASE8_BIN_ENTRIES: [DirectoryEntry; 8] = [
    ...
    DirectoryEntry::new(b"sockdiag", PHASE12_SOCKDIAG_INDEX),
];
...
static PHASE12_PINGDIAG_ELF_BYTES: [u8; PHASE8_INIT_ELF_LEN] =
    build_phase8_exit_elf_bytes(PHASE8_INIT_EXIT_STATUS);
static PHASE12_SOCKDIAG_ELF_BYTES: [u8; PHASE8_INIT_ELF_LEN] =
    build_phase8_exit_elf_bytes(PHASE8_INIT_EXIT_STATUS);

static PHASE8_NODES: [InitramfsNode; 18] = [
    ...
    InitramfsNode::regular_file(PHASE12_SOCKDIAG_INDEX, PHASE12_SOCKDIAG_BYTES),
...
mod tests {
    ...
    fn regular_file_bytes_returns_immutable_init_fixture() {
        ...
        assert_eq!(
            PHASE10_STDIN_DEV_NULL_EOF_STDOUT,
            b"Talos userspace stdin fixture read-result: null-source-eof/no-data\n"
        );
        assert_eq!(
            PHASE10_STDIN_PIPE_EOF_STDOUT,
            b"Talos userspace stdin fixture read-result: pipe-eof/no-data\n"
        );
        let stderr = fs
