...
#[cfg(any(
    ...
    talos_boot_scenario = "qemu_local_help_command",
    ...
    talos_boot_scenario = "qemu_local_shell_bare_name_command_argv",
    ...
    talos_boot_scenario = "qemu_local_shell_stdout_to_stderr_redirection",
    talos_boot_scenario = "qemu_local_shell_dev_null_stdout_redirection",
    talos_boot_scenario = "qemu_local_shell_dev_null_stderr_redirection",
    ...
    talos_boot_scenario = "qemu_local_shell_direct_combined_stdin_stdout_redirection",
    talos_boot_scenario = "qemu_local_shell_bare_name_combined_stdin_stdout_redirection",
    ...
    talos_boot_scenario = "qemu_local_shell_bare_name_stdout_regular_file_redirection",
    talos_boot_scenario = "qemu_local_shell_direct_stdout_regular_file_append_redirection",
    talos_boot_scenario = "qemu_local_shell_bare_name_stdout_regular_file_append_redirection",
    ...
    talos_boot_scenario = "qemu_local_shell_explicit_fd1_regular_file_redirection",
    ...
    talos_boot_scenario = "qemu_local_shell_direct_pipeline_output_append_regular_file_redirection",
    talos_boot_scenario = "qemu_local_shell_bare_name_pipeline_output_append_regular_file_redirection",
    talos_boot_scenario = "qemu_local_shell_direct_pipeline_stderr_regular_file_redirection",
    talos_boot_scenario = "qemu_local_shell_bare_name_pipeline_stderr_regular_file_redirection",
    ...
    talos_boot_scenario = "qemu_local_shell_direct_stderr_regular_file_append_redirection",
    talos_boot_scenario = "qemu_local_shell_bare_name_stderr_regular_file_append_redirection",
    ...
    talos_boot_scenario = "qemu_local_shell_pipeline_status",
    ...
    talos_boot_scenario = "qemu_local_shell_ps_command_vfs",
...
pub fn run_local_serial_command_loop_smoke() -> bool {
    ...
    for command_index in 0..command_count {
        ...
        crate::println!();
        crate::println!(
            "{}: dispatch command={} status={} responses={} raw-bytes={} backspaces={} deletes={} truncated={} controls={}",
            local_command_loop_smoke_label(),
            command_index,
            result.status_name(),
...
#[cfg(talos_boot_scenario = "qemu_local_literal_echo")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-literal-echo"
}

#[cfg(talos_boot_scenario = "qemu_local_help_command")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-help-command"
}
...
#[cfg(talos_boot_scenario = "qemu_local_ls_root")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-ls-root"
}

#[cfg(talos_boot_scenario = "qemu_local_ls_bin")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-ls-bin"
}

#[cfg(talos_boot_scenario = "qemu_local_cat_banner")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-cat-banner"
}

#[cfg(talos_boot_scenario = "qemu_local_cat_cwd")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-cat-cwd"
}
...
#[cfg(talos_boot_scenario = "qemu_local_shell_bare_name_command_argv")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-bare-name-command-argv"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_absolute_path_vfs_pipeline")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-absolute-path-vfs-pipeline"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_direct_pipeline_stage_argv")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-direct-pipeline-stage-argv"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_direct_pipeline_stdin_redirection")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-direct-pipeline-stdin-redirection"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_direct_pipeline_consumer_stdin_redirection")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-direct-pipeline-consumer-stdin-redirection"
}
...
#[cfg(talos_boot_scenario = "qemu_local_shell_bare_name_vfs_pipeline")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-bare-name-vfs-pipeline"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_literal_argv")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-literal-argv"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_path_lookup")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-path-lookup"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_stdout")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-userspace-stdout"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_stdin")]
const fn local_command_loop_smoke_label() -> &'static str {
...
#[cfg(talos_boot_scenario = "qemu_local_shell_distinct_stderr_routing")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-distinct-stderr-routing"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_stdout_to_stderr_redirection")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-stdout-to-stderr-redirection"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_dev_null_stdout_redirection")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-dev-null-stdout-redirection"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_dev_null_stderr_redirection")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-dev-null-stderr-redirection"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_dev_null_stdin_redirection")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-dev-null-stdin-redirection"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_readonly_regular_file_stdin_redirection")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-readonly-regular-file-stdin-redirection"
}
...
#[cfg(talos_boot_scenario = "qemu_local_shell_direct_combined_stdin_stdout_redirection")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-direct-combined-stdin-stdout-redirection"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_bare_name_combined_stdin_stdout_redirection")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-bare-name-combined-stdin-stdout-redirection"
}
...
#[cfg(talos_boot_scenario = "qemu_local_shell_bare_name_stdout_regular_file_redirection")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-bare-name-stdout-regular-file-redirection"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_direct_stdout_regular_file_append_redirection")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-direct-stdout-regular-file-append-redirection"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_bare_name_stdout_regular_file_append_redirection")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-bare-name-stdout-regular-file-append-redirection"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_stdout_regular_file_append_redirection")]
const fn local_command_loop_smoke_label() -> &'static str {
...
#[cfg(talos_boot_scenario = "qemu_local_shell_explicit_fd1_regular_file_redirection")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-explicit-fd1-regular-file-redirection"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_stdout_arbitrary_tmp_output_redirection")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-stdout-arbitrary-tmp-output-redirection"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_stderr_arbitrary_tmp_output_redirection")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-stderr-arbitrary-tmp-output-redirection"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_combined_stdin_stdout_redirection")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-combined-stdin-stdout-redirection"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_pipeline_consumer_output_redirection")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-pipeline-consumer-output-redirection"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_direct_combined_pipeline_stdin_stdout_redirection")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-direct-combined-pipeline-stdin-stdout-redirection"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_direct_combined_pipeline_stdout_append_redirection")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-direct-combined-pipeline-stdout-append-redirection"
}
...
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-direct-combined-pipeline-stderr-regular-file-redirection"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_direct_combined_pipeline_stderr_append_redirection")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-direct-combined-pipeline-stderr-append-redirection"
}
...
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-bare-name-combined-pipeline-stdout-append-redirection"
}
...
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-bare-name-combined-pipeline-stderr-regular-file-redirection"
}
...
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-bare-name-combined-pipeline-stdin-stdout-redirection"
}
...
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-direct-pipeline-output-append-regular-file-redirection"
}
...
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-bare-name-pipeline-output-append-regular-file-redirection"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_direct_pipeline_stderr_regular_file_redirection")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-direct-pipeline-stderr-regular-file-redirection"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_bare_name_pipeline_stderr_regular_file_redirection")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-bare-name-pipeline-stderr-regular-file-redirection"
}
...
#[cfg(talos_boot_scenario = "qemu_local_shell_background_vfs_exec_lifecycle")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-background-vfs-exec-lifecycle"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_jobs_accounting_list")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-jobs-accounting-list"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_multiple_background_jobs")]
const fn local_command_loop_smoke_label() -> &'static str {
...
#[cfg(talos_boot_scenario = "qemu_local_shell_direct_stderr_regular_file_append_redirection")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-direct-stderr-regular-file-append-redirection"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_bare_name_stderr_regular_file_append_redirection")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-bare-name-stderr-regular-file-append-redirection"
}
...
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-stderr-to-stdout-redirection"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_stdout_close_redirection")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-stdout-close-redirection"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_stderr_close_redirection")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-stderr-close-redirection"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_minimal_stdout_to_stdin_pipeline")]
const fn local_command_loop_smoke_label() -> &'static str {
...
#[cfg(talos_boot_scenario = "qemu_local_shell_pipeline_status")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-pipeline-status"
}
...
#[cfg(talos_boot_scenario = "qemu_local_shell_pipeline_stderr_dup_to_stdout")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-pipeline-stderr-dup-to-stdout"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_pipeline_stdout_redirect_away")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-pipeline-stdout-redirect-away"
}
...
#[cfg(talos_boot_scenario = "qemu_local_shell_waitpid_any_completed_child")]
const fn local_command_loop_smoke_label() -> &'static str {
...
#[cfg(talos_boot_scenario = "qemu_local_shell_ps_command_vfs")]
const fn local_command_loop_smoke_label() -> &'static str {
    "qemu-local-shell-ps-command-vfs"
}
...
#[cfg(talos_boot_scenario = "qemu_local_line_kill")]
const fn local_command_loop_smoke_label() -> &'static str {
...
#[cfg(all(
    ...
    not(talos_boot_scenario = "qemu_local_literal_echo"),
    not(talos_boot_scenario = "qemu_local_help_command"),
    not(talos_boot_scenario = "qemu_local_pwd_command"),
    not(talos_boot_scenario = "qemu_local_ls_root"),
    ...
    not(talos_boot_scenario = "qemu_local_shell_bare_name_command_argv"),
    not(talos_boot_scenario = "qemu_local_shell_absolute_path_vfs_pipeline"),
    not(talos_boot_scenario = "qemu_local_shell_direct_pipeline_stage_argv"),
    ...
    not(talos_boot_scenario = "qemu_local_shell_distinct_stderr_routing"),
    not(talos_boot_scenario = "qemu_local_shell_stdout_to_stderr_redirection"),
    not(talos_boot_scenario = "qemu_local_shell_dev_null_stdout_redirection"),
    not(talos_boot_scenario = "qemu_local_shell_dev_null_stderr_redirection"),
    ...
    not(talos_boot_scenario = "qemu_local_shell_direct_combined_stdin_stdout_redirection"),
    not(talos_boot_scenario = "qemu_local_shell_bare_name_combined_stdin_stdout_redirection"),
    ...
    not(talos_boot_scenario = "qemu_local_shell_bare_name_stdout_regular_file_redirection"),
    not(talos_boot_scenario = "qemu_local_shell_direct_stdout_regular_file_append_redirection"),
    not(talos_boot_scenario = "qemu_local_shell_bare_name_stdout_regular_file_append_redirection"),
    ...
    not(talos_boot_scenario = "qemu_local_shell_explicit_fd1_regular_file_redirection"),
    not(talos_boot_scenario = "qemu_local_shell_stdout_arbitrary_tmp_output_redirection"),
    ...
    not(talos_boot_scenario = "qemu_local_shell_direct_pipeline_stderr_regular_file_redirection"),
    not(
        talos_boot_scenario = "qemu_local_shell_bare_name_pipeline_stderr_regular_file_redirection"
    ),
    ...
    not(talos_boot_scenario = "qemu_local_shell_direct_stderr_regular_file_append_redirection"),
    not(talos_boot_scenario = "qemu_local_shell_bare_name_stderr_regular_file_append_redirection"),
    ...
    not(talos_boot_scenario = "qemu_local_shell_pipeline_status"),
    ...
    not(talos_boot_scenario = "qemu_local_shell_ps_command_vfs"),
...
#[cfg(talos_boot_scenario = "qemu_local_literal_echo")]
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-literal-echo-complete"
}

#[cfg(talos_boot_scenario = "qemu_local_help_command")]
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-help-command-complete"
}
...
#[cfg(talos_boot_scenario = "qemu_local_ls_root")]
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-ls-root-complete"
}

#[cfg(talos_boot_scenario = "qemu_local_ls_bin")]
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-ls-bin-complete"
}

#[cfg(talos_boot_scenario = "qemu_local_cat_banner")]
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-cat-banner-complete"
}

#[cfg(talos_boot_scenario = "qemu_local_cat_cwd")]
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-cat-cwd-complete"
}
...
#[cfg(talos_boot_scenario = "qemu_local_shell_bare_name_command_argv")]
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-shell-bare-name-command-argv-complete"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_absolute_path_vfs_pipeline")]
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-shell-absolute-path-vfs-pipeline-complete"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_direct_pipeline_stage_argv")]
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-shell-direct-pipeline-stage-argv-complete"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_direct_pipeline_stdin_redirection")]
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-shell-direct-pipeline-stdin-redirection-complete"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_direct_pipeline_consumer_stdin_redirection")]
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-shell-direct-pipeline-consumer-stdin-redirection-complete"
}
...
#[cfg(talos_boot_scenario = "qemu_local_shell_bare_name_pipeline_stage_argv")]
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-shell-bare-name-pipeline-stage-argv-complete"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_bare_name_vfs_pipeline")]
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-shell-bare-name-vfs-pipeline-complete"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_literal_argv")]
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-shell-literal-argv-complete"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_path_lookup")]
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-shell-path-lookup-complete"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_stdout")]
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-shell-userspace-stdout-complete"
}
...
#[cfg(talos_boot_scenario = "qemu_local_shell_distinct_stderr_routing")]
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-shell-distinct-stderr-routing-complete"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_stdout_to_stderr_redirection")]
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-shell-stdout-to-stderr-redirection-complete"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_dev_null_stdout_redirection")]
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-shell-dev-null-stdout-redirection-complete"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_dev_null_stderr_redirection")]
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-shell-dev-null-stderr-redirection-complete"
}
...
#[cfg(talos_boot_scenario = "qemu_local_shell_stdout_regular_file_redirection")]
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-shell-stdout-regular-file-redirection-complete"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_bare_name_stdout_regular_file_redirection")]
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-shell-bare-name-stdout-regular-file-redirection-complete"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_direct_stdout_regular_file_append_redirection")]
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-shell-direct-stdout-regular-file-append-redirection-complete"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_bare_name_stdout_regular_file_append_redirection")]
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-shell-bare-name-stdout-regular-file-append-redirection-complete"
}
...
#[cfg(talos_boot_scenario = "qemu_local_shell_combined_stdin_stdout_redirection")]
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-shell-combined-stdin-stdout-redirection-complete"
}
...
#[cfg(talos_boot_scenario = "qemu_local_shell_direct_combined_pipeline_stdin_stdout_redirection")]
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-shell-direct-combined-pipeline-stdin-stdout-redirection-complete"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_direct_combined_pipeline_stdout_append_redirection")]
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-shell-direct-combined-pipeline-stdout-append-redirection-complete"
}
...
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-shell-direct-combined-pipeline-stderr-regular-file-redirection-complete"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_direct_combined_pipeline_stderr_append_redirection")]
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-shell-direct-combined-pipeline-stderr-append-redirection-complete"
}
...
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-shell-bare-name-combined-pipeline-stdout-append-redirection-complete"
}
...
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-shell-bare-name-combined-pipeline-stderr-regular-file-redirection-complete"
}
...
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-shell-bare-name-combined-pipeline-stdin-stdout-redirection-complete"
}
...
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-shell-direct-pipeline-output-append-regular-file-redirection-complete"
}
...
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-shell-bare-name-pipeline-output-append-regular-file-redirection-complete"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_direct_pipeline_stderr_regular_file_redirection")]
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-shell-direct-pipeline-stderr-regular-file-redirection-complete"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_bare_name_pipeline_stderr_regular_file_redirection")]
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-shell-bare-name-pipeline-stderr-regular-file-redirection-complete"
}
...
#[cfg(talos_boot_scenario = "qemu_local_shell_background_vfs_exec_lifecycle")]
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-shell-background-vfs-exec-lifecycle-complete"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_jobs_accounting_list")]
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-shell-jobs-accounting-list-complete"
}
...
#[cfg(talos_boot_scenario = "qemu_local_shell_direct_stderr_regular_file_append_redirection")]
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-shell-direct-stderr-regular-file-append-redirection-complete"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_bare_name_stderr_regular_file_append_redirection")]
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-shell-bare-name-stderr-regular-file-append-redirection-complete"
}
...
#[cfg(talos_boot_scenario = "qemu_local_shell_stderr_to_stdout_redirection")]
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-shell-stderr-to-stdout-redirection-complete"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_stdout_close_redirection")]
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-shell-stdout-close-redirection-complete"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_stderr_close_redirection")]
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-shell-stderr-close-redirection-complete"
}
...
#[cfg(talos_boot_scenario = "qemu_local_shell_pipeline_status")]
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-shell-pipeline-status-complete"
}
...
#[cfg(talos_boot_scenario = "qemu_local_shell_pipeline_stderr_dup_to_stdout")]
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-shell-pipeline-stderr-dup-to-stdout-complete"
}

#[cfg(talos_boot_scenario = "qemu_local_shell_pipeline_stdout_redirect_away")]
const fn local_command_loop_smoke_classification() -> &'static str {
    "qemu-local-shell-pipeline-stdout-redirect-away-complete"
}
...
#[cfg(any(
    ...
    talos_boot_scenario = "qemu_local_command_stdin_descriptor",
    talos_boot_scenario = "qemu_local_echo_command",
    talos_boot_scenario = "qemu_local_literal_echo",
    talos_boot_scenario = "qemu_local_help_command",
    talos_boot_scenario = "qemu_local_pwd_command",
    talos_boot_scenario = "qemu_local_ls_root",
...
const fn local_command_loop_smoke_command_count() -> usize {
    if cfg!(talos_boot_scenario = "qemu_local_line_editing") {
        ...
        19
    } else if cfg!(talos_boot_scenario = "qemu_local_shell_ps_command_vfs") {
        23
        ...
        12
    } else if cfg!(talos_boot_scenario = "qemu_local_shell_dev_null_stdout_redirection") {
        12
    } else if cfg!(talos_boot_scenario = "qemu_local_shell_dev_null_stderr_redirection") {
        13
    } else if cfg!(talos_boot_scenario = "qemu_local_shell_dev_null_stdin_redirection") {
        12
    } else if cfg!(talos_boot_scenario = "qemu_local_shell_readonly_regular_file_stdin_redirection")
    {
        12
    ...
    } else if cfg!(talos_boot_scenario = "qemu_local_shell_stdout_regular_file_append_redirection")
    {
        ...
        11
    } else if cfg!(talos_boot_scenario = "qemu_local_shell_explicit_fd1_regular_file_redirection") {
        14
    } else if cfg!(talos_boot_scenario = "qemu_local_shell_stdout_arbitrary_tmp_output_redirection")
    {
        26
    } else if cfg!(talos_boot_scenario = "qemu_local_shell_stderr_arbitrary_tmp_output_redirection")
    {
        20
        ...
        talos_boot_scenario =
            "qemu_local_shell_direct_combined_pipeline_stderr_regular_file_redirection"
    ) {
        23
    } else if cfg!(
        talos_boot_scenario = "qemu_local_shell_direct_combined_pipeline_stderr_append_redirection"
        ...
        talos_boot_scenario =
            "qemu_local_shell_bare_name_combined_pipeline_stderr_regular_file_redirection"
    ) {
        25
    } else if cfg!(
        talos_boot_scenario =
            "qemu_local_shell_bare_name_combined_pipeline_stdin_stdout_redirection"
    ) {
        22
    } else if cfg!(
        talos_boot_scenario =
            "qemu_local_shell_direct_pipeline_output_append_regular_file_redirection"
    ) {
        20
    } else if cfg!(
        talos_boot_scenario =
            "qemu_local_shell_bare_name_pipeline_output_append_regular_file_redirection"
    ) {
        23
    } else if cfg!(
        talos_boot_scenario = "qemu_local_shell_direct_pipeline_stderr_regular_file_redirection"
    ...
    {
        11
    } else if cfg!(talos_boot_scenario = "qemu_local_shell_background_vfs_exec_lifecycle") {
        14
    } else if cfg!(talos_boot_scenario = "qemu_local_shell_jobs_accounting_list") {
        17
    ...
    } else if cfg!(talos_boot_scenario = "qemu_local_shell_stderr_regular_file_append_redirection")
    {
        ...
        12
    } else if cfg!(talos_boot_scenario = "qemu_local_shell_stderr_close_redirection") {
        12
    } else if cfg!(talos_boot_scenario = "qemu_local_shell_minimal_stdout_to_stdin_pipeline") {
        7
    } else if cfg!(talos_boot_scenario = "qemu_local_shell_pipeline_status") {
        12
        ...
        9
    } else if cfg!(talos_boot_scenario = "qemu_local_shell_pipeline_stdout_redirect_away") {
        9
        ...
        12
    } else if cfg!(talos_boot_scenario = "qemu_local_shell_bare_name_command_argv") {
        13
        ...
        15
    } else if cfg!(talos_boot_scenario = "qemu_local_shell_direct_pipeline_stage_argv") {
        15
    } else if cfg!(talos_boot_scenario = "qemu_local_shell_direct_pipeline_stdin_redirection") {
        16
    } else if cfg!(
        talos_boot_scenario = "qemu_local_shell_direct_pipeline_consumer_stdin_redirection"
    ) {
        ...
        7
    } else if cfg!(talos_boot_scenario = "qemu_local_ls_root") {
        6
    } else if cfg!(any(
        talos_boot_scenario = "qemu_local_echo_command",
        talos_boot_scenario = "qemu_local_literal_echo"
...
fn expected_local_command_loop_dispatch(
    ...
    match command_index {
        ...
        index
            if cfg!(
                talos_boot_scenario =
                    "qemu_local_shell_direct_stderr_regular_file_append_redirection"
            ) =>
        {
            match index {
                3 => {
                    line == b"/bin/stderr 2>/tmp/stderr.txt"
                        && status == Handled
                        && response_lines == 11
                }
                4 => line == b"waitpid" && status == Handled && response_lines == 1,
                5 => line == b"laststatus" && status == Handled && response_lines == 1,
                6 => line == b"cat /tmp/stderr.txt" && status == Handled && response_lines == 2,
                7 => {
                    line == b"/bin/stderr 2>>/tmp/stderr.txt"
                        && status == Handled
                        && response_lines == 11
                }
                8 => line == b"waitpid" && status == Handled && response_lines == 1,
                9 => line == b"laststatus" && status == Handled && response_lines == 1,
                10 => line == b"cat /tmp/stderr.txt" && status == Handled && response_lines == 2,
                11 => line == b"/bin/stderr" && status == Handled && response_lines == 10,
                12 => {
                    line == b"/bin/stderr 2>>/tmp/other.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                13 => {
                    line == b"stderr 2>>/tmp/other.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                14 => {
                    line == b"/bin/stderr | /bin/stdin 2>>/tmp/stderr.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                15 => {
                    line == b"/bin/stdin </etc/banner.txt 2>>/tmp/stderr.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                16 => {
                    line == b"/bin/stdout >>/tmp/stdout.txt"
                        && status == Handled
                        && response_lines == 11
                }
                17 => line == b"cat /etc/banner.txt" && status == Handled && response_lines == 1,
                _ => false,
            }
        }
        index
            if cfg!(
                talos_boot_scenario =
                    "qemu_local_shell_bare_name_stderr_regular_file_append_redirection"
            ) =>
        {
            match index {
                3 => {
                    line == b"stderr 2>/tmp/stderr.txt" && status == Handled && response_lines == 11
                }
                4 => line == b"waitpid" && status == Handled && response_lines == 1,
                5 => line == b"laststatus" && status == Handled && response_lines == 1,
                6 => line == b"cat /tmp/stderr.txt" && status == Handled && response_lines == 2,
                7 => {
                    line == b"stderr 2>>/tmp/stderr.txt"
                        && status == Handled
                        && response_lines == 11
                }
                8 => line == b"waitpid" && status == Handled && response_lines == 1,
                9 => line == b"laststatus" && status == Handled && response_lines == 1,
                10 => line == b"cat /tmp/stderr.txt" && status == Handled && response_lines == 2,
                11 => line == b"stderr" && status == Handled && response_lines == 10,
                12 => {
                    line == b"stderr 2>>/tmp/other.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                ...
                13 => {
                    line == b"stderr 2>>/var/err.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                14 => {
                    line == b"stderr | stdin 2>>/tmp/stderr.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                15 => {
                    line == b"stdin </etc/banner.txt 2>>/tmp/stderr.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                16 => {
                    line == b"missing 2>>/tmp/stderr.txt"
        ...
        index if cfg!(talos_boot_scenario = "qemu_local_shell_direct_stdin_redirection") => {
            match index {
                3 => {
                ...
                9 => {
                    line == b"/bin/stdout </etc/banner.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                10 => {
                    line == b"/bin/stdin </dev/null"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                11 => {
            ...
            ) =>
        {
            match index {
                3 => {
                    line == b"/bin/stdin </etc/banner.txt >/tmp/stdin-report.txt"
                        && status == Handled
                        && response_lines == 12
                }
                4 => line == b"waitpid" && status == Handled && response_lines == 1,
                5 => line == b"laststatus" && status == Handled && response_lines == 1,
                6 => {
                    line == b"cat /tmp/stdin-report.txt" && status == Handled && response_lines == 2
                }
                7 => {
                    line == b"/bin/stdin >/tmp/stdin-report.txt </etc/banner.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                8 => {
                    line == b"/bin/stdin </dev/null >/tmp/stdin-report.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                9 => {
                    line == b"/bin/stdin </etc/banner.txt 1>/tmp/stdin-report.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                10 => {
                ...
                12 => {
                    line == b"/bin/stdin </etc/banner.txt 2>/tmp/stdin-report.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                13 => {
                    line == b"/bin/stdin </etc/banner.txt >/tmp/other.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                _ => false,
        ...
        index
            if cfg!(
                talos_boot_scenario =
                    "qemu_local_shell_bare_name_combined_stdin_stdout_redirection"
            ) =>
        {
            match index {
                3 => {
                    line == b"stdin </etc/banner.txt >/tmp/stdin-report.txt"
                        && status == Handled
                        && response_lines == 12
                }
                4 => line == b"waitpid" && status == Handled && response_lines == 1,
                ...
                7 => {
                    line == b"stdin >/tmp/stdin-report.txt </etc/banner.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                8 => {
                    line == b"stdin </dev/null >/tmp/stdin-report.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                9 => {
                    line == b"stdin </etc/banner.txt 1>/tmp/stdin-report.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                10 => {
                ...
                12 => {
                    line == b"stdin </etc/banner.txt 2>/tmp/stdin-report.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                13 => {
                    line == b"stdout </etc/banner.txt >/tmp/stdin-report.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                14 => {
                    line == b"stdin </etc/banner.txt >/tmp/other.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                _ => false,
            ...
            ) =>
        {
            match index {
                3 => {
                    line == b"stdout >/tmp/stdout.txt" && status == Handled && response_lines == 11
                }
                4 => line == b"waitpid" && status == Handled && response_lines == 1,
                5 => line == b"laststatus" && status == Handled && response_lines == 1,
                6 => line == b"cat /tmp/stdout.txt" && status == Handled && response_lines == 2,
                7 => line == b"stdout" && status == Handled && response_lines == 10,
                8 => {
                    line == b"stdout >>/var/append.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                9 => {
                    line == b"stdout >/var/other.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                10 => {
                    line == b"stdout | stdin >/tmp/stdout.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                11 => {
                    line == b"stdin </etc/banner.txt >/tmp/stdout.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                12 => line == b"cat /etc/banner.txt" && status == Handled && response_lines == 1,
                _ => false,
            }
        }
        ...
        index if cfg!(talos_boot_scenario = "qemu_local_shell_bare_name_command_argv") => {
            match index {
                3 => line == b"status42 alpha beta" && status == Handled && response_lines == 10,
                4 => line == b"waitpid" && status == Handled && response_lines == 1,
                5 => line == b"laststatus" && status == Handled && response_lines == 1,
                6 => {
                    line == b"cat /proc/talos/processes" && status == Handled && response_lines == 1
                ...
                7 => line == b"ps" && status == Handled && response_lines == 1,
                8 => line == b"status42" && status == Handled && response_lines == 10,
                9 => line == b"stdout | stdin" && status == Handled && response_lines == 22,
                10 => {
                    line == b"status42 alpha beta gamma delta"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                11 => line == b"status42 *" && status == UnexpectedArgument && response_lines == 1,
                12 => line == b"missing alpha" && status == UnknownCommand && response_lines == 1,
                _ => false,
            }
        }
        index if cfg!(talos_boot_scenario = "qemu_local_shell_direct_pipeline_stage_argv") => {
            match index {
                3 => {
                    line == b"/bin/stdout alpha | /bin/stdin beta"
                        && status == Handled
                        && response_lines == 22
                }
                ...
                10 => {
                    line == b"/bin/stdout alpha beta | /bin/stdin"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                11 => {
                    line == b"/bin/stdout * | /bin/stdin"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                12 => {
                    line == b"/bin/stdout alpha | /bin/stdin beta gamma"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                13 => {
                    line == b"/bin/stdout alpha | /bin/stdin *"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                14 => {
        ...
        index
            if cfg!(talos_boot_scenario = "qemu_local_shell_direct_pipeline_stdin_redirection") =>
        {
            match index {
                3 => {
                    line == b"/bin/stdin </etc/banner.txt | /bin/stdin"
                        && status == Handled
                        && response_lines == 23
                }
                4 => line == b"waitpid 0x100001" && status == Handled && response_lines == 1,
                ...
                9 => line == b"ps" && status == Handled && response_lines == 1,
                10 => {
                    line == b"/bin/stdin </etc/banner.txt | /bin/stdout"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                11 => {
                    line == b"/bin/stdin alpha </etc/banner.txt | /bin/stdin"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                12 => {
                    line == b"/bin/stdin </etc/banner.txt | /bin/stdin beta"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                13 => {
                    line == b"/bin/stdin </dev/null | /bin/stdin"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                14 => {
                ...
                15 => {
                    line == b"/bin/stdin </etc/banner.txt | /bin/stdin | /bin/stdin"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                _ => false,
            ...
            ) =>
        {
            match index {
                3 => {
                    line == b"/bin/stdin | /bin/stdin </etc/banner.txt"
                        && status == Handled
                        && response_lines == 23
                }
                4 => line == b"waitpid 0x100001" && status == Handled && response_lines == 1,
                ...
                9 => line == b"ps" && status == Handled && response_lines == 1,
                10 => {
                    line == b"/bin/stdout | /bin/stdin </etc/banner.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                11 => {
                    line == b"/bin/stdin alpha | /bin/stdin </etc/banner.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                12 => {
                    line == b"/bin/stdin | /bin/stdin beta </etc/banner.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                13 => {
                    line == b"/bin/stdin | /bin/stdin </dev/null"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                14 => {
                ...
                15 => {
                    line == b"/bin/stdin | /bin/stdin </etc/banner.txt | /bin/stdin"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                16 => {
        ...
        index
            if cfg!(
                talos_boot_scenario =
                    "qemu_local_shell_direct_combined_pipeline_stdin_stdout_redirection"
            ) =>
        {
            match index {
                3 => {
                    line == b"/bin/stdin </etc/banner.txt | /bin/stdin >/tmp/pipeline-combined.txt"
                        && status == Handled
                        && response_lines == 24
                }
                4 => line == b"waitpid 0x100001" && status == Handled && response_lines == 1,
                5 => line == b"waitpid 0x100002" && status == Handled && response_lines == 1,
                6 => line == b"laststatus" && status == Handled && response_lines == 1,
                7 => line == b"pipestatus" && status == Handled && response_lines == 3,
                8 => {
                    line == b"cat /proc/talos/processes" && status == Handled && response_lines == 1
                }
                9 => line == b"ps" && status == Handled && response_lines == 1,
                10 => {
                    line == b"cat /tmp/pipeline-combined.txt"
                        && status == Handled
                        && response_lines == 2
                }
                11 => {
                ...
                12 => {
                    line == b"/bin/stdin </etc/banner.txt | /bin/stdin >/tmp/pipeline-report.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                13 => {
                    line == b"/bin/stdout | /bin/stdin >/tmp/pipeline-combined.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                14 => {
                    line == b"/bin/stdin </etc/banner.txt | /bin/stdin 1>/tmp/pipeline-combined.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                15 => {
                ...
                16 => {
                    line == b"/bin/stdin </etc/banner.txt | /bin/stdin >/var/x"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                _ => false,
        ...
        index
            if cfg!(
                talos_boot_scenario =
                    "qemu_local_shell_direct_combined_pipeline_stdout_append_redirection"
            ) =>
        {
            match index {
                3 => {
                    line == b"/bin/stdin </etc/banner.txt | /bin/stdin >/tmp/pipeline-combined-append.txt"
                        && status == Handled
                        && response_lines == 24
                }
                4 => {
                ...
                11 => {
                    line == b"cat /tmp/pipeline-combined-append.txt"
                        && status == Handled
                        && response_lines == 2
                }
                12 => {
                ...
                13 => {
                    line == b"stdin </etc/banner.txt | /bin/stdin >>/tmp/pipeline-combined-append.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                14 => {
                    line == b"/bin/stdin </etc/banner.txt | /bin/stdin 2>>/tmp/pipeline-combined-append.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                15 => {
                ...
                16 => {
                    line == b"/bin/stdout | /bin/stdin >>/tmp/pipeline-combined-append.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                17 => {
                    line == b"/bin/stdin </etc/banner.txt | /bin/stdin 1>/tmp/pipeline-combined-append.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                18 => {
                ...
                20 => {
                    line == b"/bin/stdin </etc/banner.txt | /bin/stdin >>/tmp/pipeline-combined-append.txt | /bin/stdin"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                21 => {
                    line == b"missing </etc/banner.txt | /bin/stdin >>/tmp/pipeline-combined-append.txt"
                        && status == UnknownCommand
                        && response_lines == 1
                }
                22 => {
                    line == b"/bin/stdin </etc/banner.txt | missing >>/tmp/pipeline-combined-append.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                _ => false,
            ...
            ) =>
        {
            match index {
                3 => {
                    line == b"/bin/stdin </etc/banner.txt | /bin/stderr 2>/tmp/pipeline-combined-stderr.txt"
                        && status == Handled
                        && response_lines == 24
                }
                4 => line == b"waitpid 0x100001" && status == Handled && response_lines == 1,
                ...
                9 => line == b"ps" && status == Handled && response_lines == 1,
                10 => {
                    line == b"cat /tmp/pipeline-combined-stderr.txt"
                        && status == Handled
                        && response_lines == 2
                }
                11 => {
                ...
                12 => line == b"/bin/stdout" && status == Handled && response_lines == 10,
                13 => line == b"/bin/stderr" && status == Handled && response_lines == 10,
                14 => {
                    line == b"stdin </etc/banner.txt | /bin/stderr 2>/tmp/pipeline-combined-stderr.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                15 => {
                ...
                16 => {
                    line == b"/bin/stdin </etc/banner.txt | /bin/stderr 2>/tmp/pipeline-stderr.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                17 => {
                    line == b"/bin/stdout | /bin/stderr 2>/tmp/pipeline-combined-stderr.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                18 => {
                ...
                19 => {
                    line == b"/bin/stdin </etc/banner.txt | /bin/stderr 2>/var/x"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                20 => {
                    line == b"/bin/stdin </etc/banner.txt | /bin/stderr 2>/tmp/pipeline-combined-stderr.txt | /bin/stdin"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                21 => {
                    line == b"missing </etc/banner.txt | /bin/stderr 2>/tmp/pipeline-combined-stderr.txt"
                        && status == UnknownCommand
                        && response_lines == 1
                }
                22 => {
                    line == b"/bin/stdin </etc/banner.txt | missing 2>/tmp/pipeline-combined-stderr.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                _ => false,
        ...
        index
            if cfg!(
                talos_boot_scenario =
                    "qemu_local_shell_direct_combined_pipeline_stderr_append_redirection"
            ) =>
        {
            match index {
                3 => {
                ...
                17 => {
                    line == b"/bin/stdout | /bin/stderr 2>>/tmp/pipeline-combined-stderr-append.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                18 => {
                ...
                19 => {
                    line == b"/bin/stdin </etc/banner.txt | /bin/stderr 1>/tmp/pipeline-combined-stderr-append.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                20 => {
                ...
                21 => {
                    line.starts_with(b"/bin/stdin </etc/banner.txt | /bin/stderr 2>>/tmp/pipeline-combined-stderr-append.txt | /bin/std")
                        && matches!(
                            status,
                            crate::local_command_loop::LocalCommandStatus::InputError(_)
                        )
                        && response_lines == 1
                }
                22 => {
                    line == b"missing </etc/banner.txt | /bin/stderr 2>>/tmp/pipeline-combined-stderr-append.txt"
                        && status == UnknownCommand
                        && response_lines == 1
                }
                23 => {
            ...
            ) =>
        {
            match index {
                ...
                11 => line == b"stdin </etc/banner.txt" && status == Handled && response_lines == 11,
                12 => {
                    line == b"/bin/stdin </etc/banner.txt | /bin/stderr 2>/tmp/pipeline-combined-stderr.txt"
                        && status == Handled
                        && response_lines == 24
                ...
                13 => line == b"/bin/stderr" && status == Handled && response_lines == 10,
                14 => {
                    line == b"missing </etc/banner.txt | stderr 2>/tmp/pipeline-combined-stderr.txt"
                        && status == UnknownCommand
                        && response_lines == 1
                }
                15 => {
                    line == b"stdin </etc/banner.txt | missing 2>/tmp/pipeline-combined-stderr.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                16 => {
                ...
                18 => {
                    line == b"stdout | stderr 2>/tmp/pipeline-combined-stderr.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                19 => {
                ...
                20 => {
                    line == b"stdin </etc/banner.txt | stderr 1>/tmp/pipeline-combined-stderr.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                21 => {
                ...
                23 => {
                    line == b"/bin/stdin </etc/banner.txt | stderr 2>/tmp/pipeline-combined-stderr.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                24 => {
                    line == b"stdin </etc/banner.txt | stderr 2>/tmp/pipeline-combined-stderr.txt | stdin"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                _ => false,
            ...
            ) =>
        {
            match index {
                3 => {
                    line == b"stdin </etc/banner.txt | stdin >/tmp/pipeline-combined-append.txt"
                        && status == Handled
                        && response_lines == 24
                }
                4 => {
                ...
                14 => {
                    line == b"missing </etc/banner.txt | stdin >>/tmp/pipeline-combined-append.txt"
                        && status == UnknownCommand
                        && response_lines == 1
                }
                15 => {
                    line == b"stdin </etc/banner.txt | missing >>/tmp/pipeline-combined-append.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                16 => {
                    line == b"stdin </etc/banner.txt | stdin 2>>/tmp/pipeline-combined-append.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                17 => {
                    line == b"stdin </etc/banner.txt | stdin >/tmp/pipeline-report.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                18 => {
                    line == b"stdin </etc/banner.txt | stdin 1>/tmp/pipeline-combined-append.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                19 => {
                ...
                20 => {
                    line == b"stdin </etc/banner.txt | stdin >>/var/x"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                21 => {
                ...
                22 => {
                    line == b"/bin/stdin </etc/banner.txt | stdin >>/tmp/pipeline-combined-append.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                23 => {
                    line == b"stdin </etc/banner.txt | stdin >>/tmp/pipeline-combined-append.txt | stdin"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                _ => false,
            ...
            ) =>
        {
            match index {
                3 => {
                    line == b"stdin </etc/banner.txt | stdin >/tmp/pipeline-combined.txt"
                        && status == Handled
                        && response_lines == 24
                }
                4 => line == b"waitpid 0x100001" && status == Handled && response_lines == 1,
                ...
                11 => {
                    line == b"stdin </etc/banner.txt" && status == Handled && response_lines == 11
                }
                12 => {
                    line == b"/bin/stdin </etc/banner.txt | /bin/stdin >/tmp/pipeline-combined.txt"
                        && status == Handled
                ...
                15 => {
                    line == b"stdout | stdin >/tmp/pipeline-combined.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                16 => {
                    line == b"stdin </etc/banner.txt | stdin 1>/tmp/pipeline-combined.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                17 => {
                ...
                19 => {
                    line == b"stdin </etc/banner.txt | /bin/stdin >/tmp/pipeline-combined.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                20 => {
                    line == b"/bin/stdin </etc/banner.txt | stdin >/tmp/pipeline-combined.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                21 => {
                    line == b"stdin </etc/banner.txt | stdin >/tmp/pipeline-combined.txt | stdin"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                _ => false,
            ...
            ) =>
        {
            match index {
                3 => {
                    line == b"stdin </etc/banner.txt | stdin"
                        && status == Handled
                        && response_lines == 23
                }
                4 => line == b"waitpid 0x100001" && status == Handled && response_lines == 1,
                ...
                9 => line == b"ps" && status == Handled && response_lines == 1,
                10 => {
                    line == b"stdin </etc/banner.txt | stdout"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                11 => {
                    line == b"stdin alpha </etc/banner.txt | stdin"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                12 => {
                    line == b"stdin </etc/banner.txt | stdin beta"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                13 => {
                    line == b"stdin </dev/null | stdin"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                14 => {
        ...
        index if cfg!(talos_boot_scenario = "qemu_local_shell_bare_name_pipeline_stage_argv") => {
            match index {
                3 => {
                    line == b"stdout alpha | stdin beta"
                        && status == Handled
                        && response_lines == 22
                }
                4 => line == b"waitpid 0x100001" && status == Handled && response_lines == 1,
                ...
                9 => line == b"ps" && status == Handled && response_lines == 1,
                10 => {
                    line == b"stdout alpha beta | stdin"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                11 => {
                ...
                12 => {
                    line == b"stdout alpha | stdin beta gamma"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                13 => {
                    line == b"stdout alpha | stdin *"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                14 => line == b"stdout | stdin" && status == Handled && response_lines == 22,
                _ => false,
            }
        }
        index if cfg!(talos_boot_scenario = "qemu_local_shell_absolute_path_vfs_pipeline") => {
            match index {
                ...
                9 => line == b"ps" && status == Handled && response_lines == 1,
                10 => {
                    line == b"/bin/stdout | exec stdin"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                11 => {
                    line == b"exec stdout | /bin/stdin"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                12 => {
                ...
                14 => {
                    line == b"/bin/stdout | /bin/stdin | /bin/stdin"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                _ => false,
        ...
        index if cfg!(talos_boot_scenario = "qemu_local_shell_bare_name_vfs_pipeline") => {
            match index {
                3 => line == b"stdout | stdin" && status == Handled && response_lines == 22,
                4 => line == b"waitpid 0x100001" && status == Handled && response_lines == 1,
                5 => line == b"waitpid 0x100002" && status == Handled && response_lines == 1,
                6 => line == b"laststatus" && status == Handled && response_lines == 1,
                7 => line == b"pipestatus" && status == Handled,
                ...
                9 => line == b"ps" && status == Handled && response_lines == 1,
                10 => {
                    line == b"stdout | /bin/stdin"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                11 => {
                    line == b"/bin/stdout | stdin"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                12 => line == b"missing | stdin" && status == UnknownCommand && response_lines == 1,
                13 => {
                    line == b"stdout | missing"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                14 => {
                    line == b"stdout 1>&2 | stdin"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                15 => {
                    line == b"stdout | stdin 1>/tmp/stdout.txt"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                16 => {
                    line == b"stdout | stdin | stdin"
                        && status == UnexpectedArgument
                        && response_lines == 1
                }
                _ => false,
        ...
        4 if cfg!(talos_boot_scenario = "qemu_local_shell_pipeline_status") => {
            line == b"exec stdout | exec stdin" && status == Handled
        }
        5 if cfg!(talos_boot_scenario = "qemu_local_shell_pipeline_status") => {
            line == b"pipestatus" && status == Handled
        }
        6 if cfg!(talos_boot_scenario = "qemu_local_shell_pipeline_status") => {
            line == b"laststatus" && status == Handled
        }
        7 if cfg!(talos_boot_scenario = "qemu_local_shell_pipeline_status") => {
            line == b"exec status42 | exec stdin" && status == Handled
        }
        8 if cfg!(talos_boot_scenario = "qemu_local_shell_pipeline_status") => {
            line == b"pipestatus" && status == Handled
        }
        9 if cfg!(talos_boot_scenario = "qemu_local_shell_pipeline_status") => {
            line == b"laststatus" && status == Handled
        }
        10 if cfg!(talos_boot_scenario = "qemu_local_shell_pipeline_status") => {
            line == b"exec stdout | exec stdin | exec stdin" && status == Handled
        }
        11 if cfg!(talos_boot_scenario = "qemu_local_shell_pipeline_status") => {
            line == b"pipestatus" && status == Handled
        }
        3 if cfg!(talos_boot_scenario = "qemu_local_shell_ps_command_vfs") => {
            line == b"exec /bin/status42" && status == Handled && response_lines == 10
        }
        4 if cfg!(talos_boot_scenario = "qemu_local_shell_ps_command_vfs") => {
            line == b"cat /proc/talos/processes" && status == Handled && response_lines == 1
        }
        5 if cfg!(talos_boot_scenario = "qemu_local_shell_ps_command_vfs") => {
            line == b"ps" && status == Handled && response_lines == 1
        }
        6 if cfg!(talos_boot_scenario = "qemu_local_shell_ps_command_vfs") => {
            line == b"waitpid" && status == Handled && response_lines == 1
        }
        7 if cfg!(talos_boot_scenario = "qemu_local_shell_ps_command_vfs") => {
            line == b"ps" && status == Handled && response_lines == 1
        }
        8 if cfg!(talos_boot_scenario = "qemu_local_shell_ps_command_vfs") => {
            line == b"exec stdout | exec stdin" && status == Handled && response_lines == 22
        }
        9 if cfg!(talos_boot_scenario = "qemu_local_shell_ps_command_vfs") => {
            line == b"cat /proc/talos/processes" && status == Handled && response_lines == 1
        }
        10 if cfg!(talos_boot_scenario = "qemu_local_shell_ps_command_vfs") => {
            line == b"ps" && status == Handled && response_lines == 1
        }
        11 if cfg!(talos_boot_scenario = "qemu_local_shell_ps_command_vfs") => {
            line == b"waitpid 0x100001" && status == Handled && response_lines == 1
        }
        12 if cfg!(talos_boot_scenario = "qemu_local_shell_ps_command_vfs") => {
            line == b"waitpid 0x100002" && status == Handled && response_lines == 1
        }
        13 if cfg!(talos_boot_scenario = "qemu_local_shell_ps_command_vfs") => {
            line == b"ps" && status == Handled && response_lines == 1
        }
        14 if cfg!(talos_boot_scenario = "qemu_local_shell_ps_command_vfs") => {
            line == b"exec /bin/status42 &" && status == Handled && response_lines == 8
        }
        15 if cfg!(talos_boot_scenario = "qemu_local_shell_ps_command_vfs") => {
            line == b"cat /proc/talos/processes" && status == Handled && response_lines == 2
        }
        16 if cfg!(talos_boot_scenario = "qemu_local_shell_ps_command_vfs") => {
            line == b"ps" && status == Handled && response_lines == 1
        }
        17 if cfg!(talos_boot_scenario = "qemu_local_shell_ps_command_vfs") => {
            line == b"waitpid 0x100001" && status == Handled && response_lines == 1
        }
        18 if cfg!(talos_boot_scenario = "qemu_local_shell_ps_command_vfs") => {
            line == b"ps" && status == Handled && response_lines == 1
        }
        19 if cfg!(talos_boot_scenario = "qemu_local_shell_ps_command_vfs") => {
            line == b"ps -a" && status == UnexpectedArgument && response_lines == 1
        }
        20 if cfg!(talos_boot_scenario = "qemu_local_shell_ps_command_vfs") => {
            line == b"ps extra" && status == UnexpectedArgument && response_lines == 1
        }
        21 if cfg!(talos_boot_scenario = "qemu_local_shell_ps_command_vfs") => {
            line == b"cat /etc/banner.txt" && status == Handled && response_lines == 1
        }
        22 if cfg!(talos_boot_scenario = "qemu_local_shell_ps_command_vfs") => {
        ...
        4 if cfg!(talos_boot_scenario = "qemu_local_shell_combined_stdin_stdout_redirection") => {
            line == b"waitpid" && status == Handled && response_lines == 1
        }
        5 if cfg!(talos_boot_scenario = "qemu_local_shell_combined_stdin_stdout_redirection") => {
            line == b"laststatus" && status == Handled && response_lines == 1
        }
        6 if cfg!(talos_boot_scenario = "qemu_local_shell_combined_stdin_stdout_redirection") => {
            line == b"cat /tmp/stdin-report.txt" && status == Handled && response_lines == 2
        }
        7 if cfg!(talos_boot_scenario = "qemu_local_shell_combined_stdin_stdout_redirection") => {
            line == b"exec stdin >/tmp/stdin-report.txt </etc/banner.txt"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        8 if cfg!(talos_boot_scenario = "qemu_local_shell_combined_stdin_stdout_redirection") => {
            line == b"exec stdin </dev/null >/tmp/stdin-report.txt"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        9 if cfg!(talos_boot_scenario = "qemu_local_shell_combined_stdin_stdout_redirection") => {
            line == b"exec stdin </etc/banner.txt 1>/tmp/stdin-report.txt"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        10 if cfg!(talos_boot_scenario = "qemu_local_shell_combined_stdin_stdout_redirection") => {
            line == b"exec stdin < /etc/banner.txt >/tmp/stdin-report.txt"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        ...
        {
            line == b"cat /tmp/pipe-consumer.txt" && status == Handled && response_lines == 2
        }
        7 if cfg!(
            talos_boot_scenario = "qemu_local_shell_pipeline_consumer_output_redirection"
        ) =>
        ...
        {
            line == b"exec stderr | exec stdin >/tmp/pipe-consumer.txt"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        10 if cfg!(
        ...
        {
            line == b"/bin/stdout | /bin/stdin >/tmp/pipeline-report.txt"
                && status == Handled
                && response_lines == 23
        }
        4 if cfg!(
        ...
        {
            line == b"cat /tmp/pipeline-report.txt" && status == Handled && response_lines == 2
        }
        12 if cfg!(
            talos_boot_scenario =
                "qemu_local_shell_direct_pipeline_output_append_regular_file_redirection"
        ...
        {
            line == b"/bin/stdout | /bin/stdin >/tmp/stdout.txt"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        14 if cfg!(
        ...
        {
            line == b"stdout | stdin >>/tmp/pipeline-report.txt"
                && status == Handled
                && response_lines == 23
        }
        15 if cfg!(
        ...
        {
            line == b"/bin/stdout | /bin/stderr >>/tmp/pipeline-report.txt"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        16 if cfg!(
        ...
        {
            line == b"/bin/stdout | /bin/stdin 2>>/tmp/x"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        17 if cfg!(
        ...
        {
            line == b"/bin/stdout | /bin/stdin >>/var/x"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        3 if cfg!(
        ...
        {
            line == b"/bin/stdout | /bin/stderr >/tmp/pipeline-stderr.txt"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        14 if cfg!(
        ...
        {
            line == b"/bin/stdout | /bin/stderr </etc/banner.txt"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        15 if cfg!(
        ...
        {
            line == b"stdout | stderr 2>>/tmp/stderr.txt"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        3 if cfg!(
            talos_boot_scenario =
                "qemu_local_shell_bare_name_pipeline_stderr_regular_file_redirection"
        ) =>
        {
        ...
        {
            line == b"stderr" && status == Handled && response_lines == 10
        }
        13 if cfg!(
            talos_boot_scenario =
                "qemu_local_shell_bare_name_pipeline_stderr_regular_file_redirection"
        ...
        {
            line == b"stdout | stderr >/tmp/pipeline-stderr.txt"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        15 if cfg!(
        ...
        {
            line == b"stdout | stderr </etc/banner.txt"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        16 if cfg!(
        ...
        {
            line == b"stdout | bin/stderr 2>/tmp/pipeline-stderr.txt"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        20 if cfg!(
        ...
        {
            line == b"/bin/stdout | stderr 2>/tmp/pipeline-stderr.txt"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        21 if cfg!(
        ...
        {
            line == b"nosuch | stderr 2>/tmp/pipeline-stderr.txt"
                && status == UnknownCommand
                && response_lines == 1
        }
        22 if cfg!(
        ...
        {
            line == b"stdout | nosuch 2>/tmp/pipeline-stderr.txt"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        3 if cfg!(
        ...
        {
            line == b"stdout" && status == Handled && response_lines == 10
        }
        13 if cfg!(
            talos_boot_scenario =
                "qemu_local_shell_bare_name_pipeline_output_append_regular_file_redirection"
        ...
        {
            line == b"stdout | stderr >/tmp/pipeline-report.txt"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        16 if cfg!(
        ...
        {
            line == b"stdout | stdin 1>/tmp/pipeline-report.txt"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        17 if cfg!(
        ...
        {
            line == b"stdout | bin/stdin >/tmp/pipeline-report.txt"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        19 if cfg!(
        ...
        3 if cfg!(talos_boot_scenario = "qemu_local_shell_background_vfs_exec_lifecycle") => {
            line == b"exec /bin/status42 &" && status == Handled && response_lines == 8
        }
        4 if cfg!(talos_boot_scenario = "qemu_local_shell_background_vfs_exec_lifecycle") => {
            line == b"cat /etc/banner.txt" && status == Handled && response_lines == 2
        }
        5 if cfg!(talos_boot_scenario = "qemu_local_shell_background_vfs_exec_lifecycle") => {
            line == b"waitpid" && status == Handled && response_lines == 1
        }
        6 if cfg!(talos_boot_scenario = "qemu_local_shell_background_vfs_exec_lifecycle") => {
            line == b"laststatus" && status == Handled && response_lines == 1
        }
        7 if cfg!(talos_boot_scenario = "qemu_local_shell_background_vfs_exec_lifecycle") => {
            line == b"exec /bin/zero" && status == Handled && response_lines == 10
        }
        8 if cfg!(talos_boot_scenario = "qemu_local_shell_background_vfs_exec_lifecycle") => {
            line == b"waitpid" && status == Handled && response_lines == 1
        }
        9 if cfg!(talos_boot_scenario = "qemu_local_shell_background_vfs_exec_lifecycle") => {
            line == b"laststatus" && status == Handled && response_lines == 1
        }
        ...
        12 if cfg!(talos_boot_scenario = "qemu_local_shell_background_vfs_exec_lifecycle") => {
            line == b"exec /bin/status42&" && status == UnexpectedArgument && response_lines == 1
        }
        13 if cfg!(talos_boot_scenario = "qemu_local_shell_background_vfs_exec_lifecycle") => {
            line == b"exec stdout &" && status == UnexpectedArgument && response_lines == 1
        }
        3 if cfg!(talos_boot_scenario = "qemu_local_shell_jobs_accounting_list") => {
            line == b"jobs" && status == Handled && response_lines == 1
        }
        4 if cfg!(talos_boot_scenario = "qemu_local_shell_jobs_accounting_list") => {
            line == b"exec /bin/status42 &" && status == Handled && response_lines == 8
        }
        5 if cfg!(talos_boot_scenario = "qemu_local_shell_jobs_accounting_list") => {
            line == b"jobs" && status == Handled && response_lines == 1
        }
        6 if cfg!(talos_boot_scenario = "qemu_local_shell_jobs_accounting_list") => {
            line == b"jobs" && status == Handled && response_lines == 1
        }
        7 if cfg!(talos_boot_scenario = "qemu_local_shell_jobs_accounting_list") => {
            line == b"waitpid" && status == Handled && response_lines == 1
        }
        8 if cfg!(talos_boot_scenario = "qemu_local_shell_jobs_accounting_list") => {
            line == b"laststatus" && status == Handled && response_lines == 1
        }
        9 if cfg!(talos_boot_scenario = "qemu_local_shell_jobs_accounting_list") => {
            line == b"exec /bin/zero" && status == Handled && response_lines == 10
        }
        10 if cfg!(talos_boot_scenario = "qemu_local_shell_jobs_accounting_list") => {
            line == b"waitpid" && status == Handled && response_lines == 1
        }
        11 if cfg!(talos_boot_scenario = "qemu_local_shell_jobs_accounting_list") => {
            line == b"laststatus" && status == Handled && response_lines == 1
        }
        ...
        14 if cfg!(talos_boot_scenario = "qemu_local_shell_jobs_accounting_list") => {
            line == b"fg" && status == UnknownCommand && response_lines == 1
        }
        15 if cfg!(talos_boot_scenario = "qemu_local_shell_jobs_accounting_list") => {
            line == b"bg" && status == UnknownCommand && response_lines == 1
        }
        16 if cfg!(talos_boot_scenario = "qemu_local_shell_jobs_accounting_list") => {
            line == b"kill %1" && status == UnknownCommand && response_lines == 1
        }
        3 if cfg!(talos_boot_scenario = "qemu_local_shell_multiple_background_jobs") => {
            line == b"jobs" && status == Handled && response_lines == 1
        }
        4 if cfg!(talos_boot_scenario = "qemu_local_shell_multiple_background_jobs") => {
            line == b"exec /bin/status42 &" && status == Handled && response_lines == 8
        }
        5 if cfg!(talos_boot_scenario = "qemu_local_shell_multiple_background_jobs") => {
            line == b"exec /bin/zero &" && status == Handled && response_lines == 9
        }
        6 if cfg!(talos_boot_scenario = "qemu_local_shell_multiple_background_jobs") => {
        ...
        9 if cfg!(talos_boot_scenario = "qemu_local_shell_multiple_background_jobs") => {
            line == b"laststatus" && status == Handled && response_lines == 1
        }
        10 if cfg!(talos_boot_scenario = "qemu_local_shell_multiple_background_jobs") => {
            line == b"exec /bin/zero" && status == Handled && response_lines == 10
        }
        11 if cfg!(talos_boot_scenario = "qemu_local_shell_multiple_background_jobs") => {
            line == b"waitpid" && status == Handled && response_lines == 1
        }
        12 if cfg!(talos_boot_scenario = "qemu_local_shell_multiple_background_jobs") => {
            line == b"laststatus" && status == Handled && response_lines == 1
        }
        13 if cfg!(talos_boot_scenario = "qemu_local_shell_multiple_background_jobs") => {
            line == b"exec /bin/status42&" && status == UnexpectedArgument && response_lines == 1
        }
        ...
        {
            line == b"exec stdout >/tmp/alpha.log" && status == Handled && response_lines == 11
        }
        4 if cfg!(
            talos_boot_scenario = "qemu_local_shell_stdout_arbitrary_tmp_output_redirection"
        ) =>
        ...
        {
            line == b"cat /tmp/alpha.log" && status == Handled && response_lines == 2
        }
        7 if cfg!(
            talos_boot_scenario = "qemu_local_shell_stdout_arbitrary_tmp_output_redirection"
        ) =>
        {
            line == b"exec stdout >>/tmp/beta.out" && status == Handled && response_lines == 11
        }
        8 if cfg!(
            talos_boot_scenario = "qemu_local_shell_stdout_arbitrary_tmp_output_redirection"
        ) =>
        ...
        {
            line == b"cat /tmp/beta.out" && status == Handled && response_lines == 2
        }
        11 if cfg!(
            talos_boot_scenario = "qemu_local_shell_stdout_arbitrary_tmp_output_redirection"
        ) =>
        {
            line == b"exec stdout 1>/tmp/gamma.log" && status == Handled && response_lines == 11
        }
        12 if cfg!(
            talos_boot_scenario = "qemu_local_shell_stdout_arbitrary_tmp_output_redirection"
        ) =>
        ...
        {
            line == b"cat /tmp/gamma.log" && status == Handled && response_lines == 2
        }
        15 if cfg!(
            talos_boot_scenario = "qemu_local_shell_stdout_arbitrary_tmp_output_redirection"
        ) =>
        {
            line == b"exec stdout 1>>/tmp/delta.out" && status == Handled && response_lines == 11
        }
        16 if cfg!(
            talos_boot_scenario = "qemu_local_shell_stdout_arbitrary_tmp_output_redirection"
        ) =>
        ...
        {
            line == b"cat /tmp/delta.out" && status == Handled && response_lines == 2
        }
        19 if cfg!(
            talos_boot_scenario = "qemu_local_shell_stdout_arbitrary_tmp_output_redirection"
        ) =>
        ...
        {
            line == b"exec stdout >/var/out.txt"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        21 if cfg!(
        ...
        {
            line == b"exec stdout >/tmp/nested/out.txt"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        22 if cfg!(
        ...
        {
            line == b"exec stdout >/tmp/" && status == UnexpectedArgument && response_lines == 1
        }
        23 if cfg!(
            talos_boot_scenario = "qemu_local_shell_stdout_arbitrary_tmp_output_redirection"
        ) =>
        {
            line == b"exec stdout 3>/tmp/alpha.log"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        24 if cfg!(
        ...
        {
            line == b"exec stdout >/tmp/../bad.txt"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        25 if cfg!(
        ...
        {
            line == b"exec stderr 2>/tmp/omega.err" && status == Handled && response_lines == 11
        }
        4 if cfg!(
            talos_boot_scenario = "qemu_local_shell_stderr_arbitrary_tmp_output_redirection"
        ) =>
        ...
        {
            line == b"cat /tmp/omega.err" && status == Handled && response_lines == 2
        }
        7 if cfg!(
            talos_boot_scenario = "qemu_local_shell_stderr_arbitrary_tmp_output_redirection"
        ) =>
        {
            line == b"exec stderr 2>>/tmp/theta.log" && status == Handled && response_lines == 11
        }
        8 if cfg!(
            talos_boot_scenario = "qemu_local_shell_stderr_arbitrary_tmp_output_redirection"
        ) =>
        ...
        {
            line == b"cat /tmp/theta.log" && status == Handled && response_lines == 2
        }
        11 if cfg!(
            talos_boot_scenario = "qemu_local_shell_stderr_arbitrary_tmp_output_redirection"
        ) =>
        ...
        {
            line == b"exec stderr 2>/var/err.txt"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        14 if cfg!(
        ...
        {
            line == b"exec stderr 2>/tmp/n/e" && status == UnexpectedArgument && response_lines == 1
        }
        15 if cfg!(
            talos_boot_scenario = "qemu_local_shell_stderr_arbitrary_tmp_output_redirection"
        ) =>
        {
            line == b"exec stderr 2>/tmp/" && status == UnexpectedArgument && response_lines == 1
        }
        16 if cfg!(
            talos_boot_scenario = "qemu_local_shell_stderr_arbitrary_tmp_output_redirection"
        ) =>
        {
            line == b"exec stderr 3>/tmp/omega.err"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        17 if cfg!(
        ...
        {
            line == b"exec stderr 2>/tmp/../bad.txt"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        18 if cfg!(
        ...
        {
            line == b"exec stderr >/tmp/misbound.err"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        ...
        3 if cfg!(talos_boot_scenario = "qemu_local_line_kill") => {
            line == b"pwd" && status == Handled && response_lines == 2
        }
        3 if cfg!(talos_boot_scenario = "qemu_local_pwd_command") => {
            line == b"pwd" && status == Handled && response_lines == 1
        }
        3 if cfg!(talos_boot_scenario = "qemu_local_ls_root") => {
        ...
        3 if cfg!(talos_boot_scenario = "qemu_local_cat_cwd") => {
            line == b"cd /etc" && status == Handled && response_lines == 0
        }
        3 if cfg!(talos_boot_scenario = "qemu_local_shell_vfs_exec") => {
            line == b"exec /bin/status42" && status == Handled && response_lines == 10
        }
        3 if cfg!(talos_boot_scenario = "qemu_local_shell_literal_argv") => {
            line == b"exec /bin/status42 alpha beta" && status == Handled && response_lines == 10
        }
        3 if cfg!(talos_boot_scenario = "qemu_local_shell_path_lookup") => {
            line == b"exec status42 alpha beta" && status == Handled && response_lines == 10
        }
        3 if cfg!(talos_boot_scenario = "qemu_local_shell_stdout") => {
            line == b"exec stdout" && status == Handled && response_lines == 10
        }
        3 if cfg!(talos_boot_scenario = "qemu_local_shell_stdout_to_stderr_redirection") => {
            line == b"exec stdout 1>&2" && status == Handled && response_lines == 11
        }
        3 if cfg!(talos_boot_scenario = "qemu_local_shell_dev_null_stdout_redirection") => {
            line == b"exec stdout >/dev/null" && status == Handled && response_lines == 11
        }
        3 if cfg!(talos_boot_scenario = "qemu_local_shell_dev_null_stderr_redirection") => {
            line == b"exec stderr 2>/dev/null" && status == Handled && response_lines == 11
        }
        3 if cfg!(talos_boot_scenario = "qemu_local_shell_dev_null_stdin_redirection") => {
            line == b"exec stdin </dev/null" && status == Handled && response_lines == 11
        }
        3 if cfg!(
            talos_boot_scenario = "qemu_local_shell_readonly_regular_file_stdin_redirection"
        ) =>
        ...
        3 if cfg!(
            talos_boot_scenario =
                "qemu_local_shell_bare_name_stdout_regular_file_append_redirection"
        ) =>
        {
            line == b"stdout >/tmp/stdout.txt" && status == Handled && response_lines == 11
        }
        ...
        {
            line == b"exec stdout 1>/tmp/stdout.txt" && status == Handled && response_lines == 11
        }
        ...
        3 if cfg!(talos_boot_scenario = "qemu_local_shell_stdout_close_redirection") => {
            line == b"exec stdout 1>&-" && status == Handled && response_lines == 11
        }
        3 if cfg!(talos_boot_scenario = "qemu_local_shell_stderr_close_redirection") => {
        ...
        3 if cfg!(talos_boot_scenario = "qemu_local_shell_waitpid_any_completed_child") => {
            line == b"waitpid" && status == Handled && response_lines == 1
        }
        ...
        3 if cfg!(talos_boot_scenario = "qemu_local_literal_echo") => {
        ...
        4 if cfg!(talos_boot_scenario = "qemu_local_ls_root") => {
            line.is_empty() && status == Empty && response_lines == 1
        }
        4 if cfg!(talos_boot_scenario = "qemu_local_ls_bin") => {
            line == b"ls /" && status == Handled && response_lines == 4
        }
        4 if cfg!(talos_boot_scenario = "qemu_local_cat_banner") => {
            line == b"ls /bin" && status == Handled && response_lines == 8
        }
        ...
        4 if cfg!(talos_boot_scenario = "qemu_local_shell_literal_argv") => {
            line == b"waitpid" && status == Handled && response_lines == 1
        }
        4 if cfg!(talos_boot_scenario = "qemu_local_shell_path_lookup") => {
            line == b"waitpid" && status == Handled && response_lines == 1
        }
        4 if cfg!(talos_boot_scenario = "qemu_local_shell_stdout") => {
            line == b"waitpid" && status == Handled && response_lines == 1
        }
        4 if cfg!(talos_boot_scenario = "qemu_local_shell_stdout_to_stderr_redirection") => {
            line == b"waitpid" && status == Handled && response_lines == 1
        }
        4 if cfg!(talos_boot_scenario = "qemu_local_shell_dev_null_stdout_redirection") => {
            line == b"waitpid" && status == Handled && response_lines == 1
        }
        4 if cfg!(talos_boot_scenario = "qemu_local_shell_dev_null_stderr_redirection") => {
            line == b"waitpid" && status == Handled && response_lines == 1
        }
        4 if cfg!(talos_boot_scenario = "qemu_local_shell_dev_null_stdin_redirection") => {
            line == b"waitpid" && status == Handled && response_lines == 1
        }
        4 if cfg!(
            talos_boot_scenario = "qemu_local_shell_readonly_regular_file_stdin_redirection"
        ...
        4 if cfg!(talos_boot_scenario = "qemu_local_shell_stdout_regular_file_redirection") => {
            line == b"waitpid" && status == Handled && response_lines == 1
        }
        4 if cfg!(any(
            talos_boot_scenario = "qemu_local_shell_direct_stdout_regular_file_append_redirection",
        ...
        4 if cfg!(talos_boot_scenario = "qemu_local_shell_stderr_regular_file_redirection") => {
            line == b"waitpid" && status == Handled && response_lines == 1
        }
        4 if cfg!(
            talos_boot_scenario = "qemu_local_shell_stderr_regular_file_append_redirection"
        ...
        4 if cfg!(talos_boot_scenario = "qemu_local_shell_stderr_to_stdout_redirection") => {
            line == b"waitpid" && status == Handled && response_lines == 1
        }
        4 if cfg!(talos_boot_scenario = "qemu_local_shell_stdout_close_redirection") => {
            line == b"waitpid" && status == Handled && response_lines == 1
        }
        4 if cfg!(talos_boot_scenario = "qemu_local_shell_stderr_close_redirection") => {
            line == b"waitpid" && status == Handled && response_lines == 1
        }
        ...
        4 if cfg!(talos_boot_scenario = "qemu_local_shell_pipeline_stderr_dup_to_stdout") => {
            line == b"waitpid" && status == Handled && response_lines == 1
        }
        4 if cfg!(talos_boot_scenario = "qemu_local_shell_pipeline_stdout_redirect_away") => {
            line == b"waitpid" && status == Handled && response_lines == 1
        }
        ...
        4 if cfg!(talos_boot_scenario = "qemu_local_shell_waitpid_any_completed_child") => {
            line == b"exec /bin/status42" && status == Handled && response_lines == 10
        }
        ...
        4 if cfg!(talos_boot_scenario = "qemu_local_line_kill") => {
            line == b"pwd" && status == Handled && response_lines == 1
        }
        ...
        4 if cfg!(talos_boot_scenario = "qemu_local_literal_echo") => {
            line.is_empty() && status == Empty && response_lines == 1
        }
        4 => line == b"bogus" && status == UnknownCommand && response_lines == 1,
        5 if cfg!(talos_boot_scenario = "qemu_local_line_editing") => {
            line == b"echo hello" && status == Handled && response_lines == 1
        }
        5 if cfg!(talos_boot_scenario = "qemu_local_pwd_command") => {
            line.is_empty() && status == Empty && response_lines == 1
        }
        5 if cfg!(talos_boot_scenario = "qemu_local_ls_root") => {
            line == b"bogus" && status == UnknownCommand && response_lines == 1
        }
        5 if cfg!(talos_boot_scenario = "qemu_local_ls_bin") => {
            line.is_empty() && status == Empty && response_lines == 1
        }
        5 if cfg!(talos_boot_scenario = "qemu_local_cat_banner") => {
            line.is_empty() && status == Empty && response_lines == 1
        }
        5 if cfg!(talos_boot_scenario = "qemu_local_cat_cwd") => {
            line == b"cd /" && status == Handled && response_lines == 0
        }
        5 if cfg!(talos_boot_scenario = "qemu_local_shell_waitpid_any_completed_child") => {
            line == b"waitpid" && status == Handled && response_lines == 1
        }
        5 if cfg!(talos_boot_scenario = "qemu_local_shell_vfs_exec") => {
            line == b"exec /bin/init" && status == Handled && response_lines == 11
        }
        5 if cfg!(talos_boot_scenario = "qemu_local_shell_literal_argv") => {
            line == b"laststatus" && status == Handled && response_lines == 1
        }
        5 if cfg!(talos_boot_scenario = "qemu_local_shell_path_lookup") => {
            line == b"laststatus" && status == Handled && response_lines == 1
        }
        5 if cfg!(talos_boot_scenario = "qemu_local_shell_stdout") => {
            line == b"laststatus" && status == Handled && response_lines == 1
        }
        5 if cfg!(talos_boot_scenario = "qemu_local_shell_stdout_to_stderr_redirection") => {
            line == b"laststatus" && status == Handled && response_lines == 1
        }
        5 if cfg!(talos_boot_scenario = "qemu_local_shell_dev_null_stdout_redirection") => {
            line == b"laststatus" && status == Handled && response_lines == 1
        }
        5 if cfg!(talos_boot_scenario = "qemu_local_shell_dev_null_stderr_redirection") => {
            line == b"laststatus" && status == Handled && response_lines == 1
        }
        5 if cfg!(talos_boot_scenario = "qemu_local_shell_dev_null_stdin_redirection") => {
            line == b"laststatus" && status == Handled && response_lines == 1
        }
        5 if cfg!(
            talos_boot_scenario = "qemu_local_shell_readonly_regular_file_stdin_redirection"
        ...
        5 if cfg!(talos_boot_scenario = "qemu_local_shell_stdout_regular_file_redirection") => {
            line == b"laststatus" && status == Handled && response_lines == 1
        }
        5 if cfg!(any(
            talos_boot_scenario = "qemu_local_shell_direct_stdout_regular_file_append_redirection",
        ...
        5 if cfg!(talos_boot_scenario = "qemu_local_shell_stderr_regular_file_redirection") => {
            line == b"laststatus" && status == Handled && response_lines == 1
        }
        5 if cfg!(
            talos_boot_scenario = "qemu_local_shell_stderr_regular_file_append_redirection"
        ...
        5 if cfg!(talos_boot_scenario = "qemu_local_shell_stdout_close_redirection") => {
            line == b"laststatus" && status == Handled && response_lines == 1
        }
        5 if cfg!(talos_boot_scenario = "qemu_local_shell_stderr_close_redirection") => {
            line == b"laststatus" && status == Handled && response_lines == 1
        }
        ...
        5 if cfg!(talos_boot_scenario = "qemu_local_shell_pipeline_stderr_dup_to_stdout") => {
            line == b"laststatus" && status == Handled && response_lines == 1
        }
        5 if cfg!(talos_boot_scenario = "qemu_local_shell_pipeline_stdout_redirect_away") => {
            line == b"laststatus" && status == Handled && response_lines == 1
        }
        ...
        5 if cfg!(talos_boot_scenario = "qemu_local_literal_echo") => {
            line == b"bogus" && status == UnknownCommand && response_lines == 1
        }
        6 if cfg!(talos_boot_scenario = "qemu_local_pwd_command") => {
            line == b"bogus" && status == UnknownCommand && response_lines == 1
        }
        6 if cfg!(talos_boot_scenario = "qemu_local_ls_bin") => {
            line == b"bogus" && status == UnknownCommand && response_lines == 1
        }
        6 if cfg!(talos_boot_scenario = "qemu_local_cat_banner") => {
            line == b"bogus" && status == UnknownCommand && response_lines == 1
        }
        6 if cfg!(talos_boot_scenario = "qemu_local_cat_cwd") => {
            line == b"cat banner.txt" && status == UnexpectedArgument && response_lines == 1
        }
        6 if cfg!(talos_boot_scenario = "qemu_local_shell_waitpid_any_completed_child") => {
            line == b"waitpid" && status == Handled && response_lines == 1
        }
        6 if cfg!(talos_boot_scenario = "qemu_local_shell_vfs_exec") => {
            line == b"laststatus" && status == Handled && response_lines == 1
        }
        6 if cfg!(talos_boot_scenario = "qemu_local_shell_literal_argv") => {
            line == b"exec /bin/init" && status == Handled && response_lines == 11
        }
        6 if cfg!(talos_boot_scenario = "qemu_local_shell_path_lookup") => {
            line == b"exec init" && status == Handled && response_lines == 11
        }
        6 if cfg!(talos_boot_scenario = "qemu_local_shell_stdout") => {
            line == b"exec status42" && status == Handled && response_lines == 10
        }
        6 if cfg!(talos_boot_scenario = "qemu_local_shell_stdout_to_stderr_redirection") => {
            line == b"exec stdout" && status == Handled && response_lines == 10
        }
        6 if cfg!(talos_boot_scenario = "qemu_local_shell_dev_null_stdout_redirection") => {
            line == b"exec stdout" && status == Handled && response_lines == 10
        }
        6 if cfg!(talos_boot_scenario = "qemu_local_shell_dev_null_stderr_redirection") => {
            line == b"exec stderr" && status == Handled && response_lines == 10
        }
        6 if cfg!(talos_boot_scenario = "qemu_local_shell_dev_null_stdin_redirection") => {
            line == b"exec stdin" && status == Handled && response_lines == 10
        }
        6 if cfg!(
            talos_boot_scenario = "qemu_local_shell_readonly_regular_file_stdin_redirection"
        ...
        6 if cfg!(talos_boot_scenario = "qemu_local_shell_stdout_regular_file_redirection") => {
        ...
        6 if cfg!(talos_boot_scenario = "qemu_local_shell_stdout_close_redirection") => {
            line == b"exec stdout" && status == Handled && response_lines == 10
        }
        6 if cfg!(talos_boot_scenario = "qemu_local_shell_stderr_close_redirection") => {
            line == b"exec stderr" && status == Handled && response_lines == 10
        }
        ...
        7 if cfg!(talos_boot_scenario = "qemu_local_shell_waitpid_any_completed_child") => {
            line == b"laststatus" && status == Handled && response_lines == 1
        }
        ...
        7 if cfg!(talos_boot_scenario = "qemu_local_shell_path_lookup") => {
            line == b"exec zero" && status == Handled && response_lines == 10
        }
        7 if cfg!(talos_boot_scenario = "qemu_local_shell_stdout") => {
            line == b"waitpid" && status == Handled && response_lines == 1
        }
        7 if cfg!(talos_boot_scenario = "qemu_local_shell_stdout_to_stderr_redirection") => {
            line == b"waitpid" && status == Handled && response_lines == 1
        }
        7 if cfg!(talos_boot_scenario = "qemu_local_shell_dev_null_stdout_redirection") => {
            line == b"waitpid" && status == Handled && response_lines == 1
        }
        7 if cfg!(talos_boot_scenario = "qemu_local_shell_dev_null_stderr_redirection") => {
            line == b"waitpid" && status == Handled && response_lines == 1
        }
        7 if cfg!(talos_boot_scenario = "qemu_local_shell_dev_null_stdin_redirection") => {
            line == b"waitpid" && status == Handled && response_lines == 1
        }
        7 if cfg!(
            talos_boot_scenario = "qemu_local_shell_readonly_regular_file_stdin_redirection"
        ...
        7 if cfg!(talos_boot_scenario = "qemu_local_shell_stdout_close_redirection") => {
            line == b"waitpid" && status == Handled && response_lines == 1
        }
        7 if cfg!(talos_boot_scenario = "qemu_local_shell_stderr_close_redirection") => {
            line == b"waitpid" && status == Handled && response_lines == 1
        }
        ...
        8 if cfg!(talos_boot_scenario = "qemu_local_shell_pipeline_stderr_dup_to_stdout") => {
            line == b"cat /etc/banner.txt" && status == Handled && response_lines == 1
        }
        8 if cfg!(talos_boot_scenario = "qemu_local_shell_pipeline_stdout_redirect_away") => {
            line == b"cat /etc/banner.txt" && status == Handled && response_lines == 1
        }
        ...
        8 if cfg!(talos_boot_scenario = "qemu_local_shell_literal_argv") => {
            line == b"exec /bin/status42 *" && status == UnexpectedArgument && response_lines == 1
        }
        8 if cfg!(talos_boot_scenario = "qemu_local_shell_path_lookup") => {
            line == b"exec /bin/status42 gamma" && status == Handled && response_lines == 10
        }
        8 if cfg!(talos_boot_scenario = "qemu_local_shell_stdout") => {
            line == b"exec init" && status == Handled && response_lines == 11
        }
        8 if cfg!(talos_boot_scenario = "qemu_local_shell_stdout_to_stderr_redirection") => {
            line == b"exec stdout 2>&3" && status == UnexpectedArgument && response_lines == 1
        }
        8 if cfg!(talos_boot_scenario = "qemu_local_shell_dev_null_stdout_redirection") => {
            line == b"exec stdout 1>/dev/null"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        8 if cfg!(talos_boot_scenario = "qemu_local_shell_dev_null_stderr_redirection") => {
            line == b"exec stdout >/dev/null" && status == Handled && response_lines == 11
        }
        8 if cfg!(talos_boot_scenario = "qemu_local_shell_dev_null_stdin_redirection") => {
            line == b"exec stdout </dev/null" && status == UnexpectedArgument && response_lines == 1
        }
        8 if cfg!(
            talos_boot_scenario = "qemu_local_shell_readonly_regular_file_stdin_redirection"
        ) =>
        ...
        8 if cfg!(talos_boot_scenario = "qemu_local_shell_stdout_regular_file_redirection") => {
            line == b"waitpid" && status == Handled && response_lines == 1
        }
        8 if cfg!(any(
            talos_boot_scenario = "qemu_local_shell_direct_stdout_regular_file_append_redirection",
        ...
        {
            line == b"exec stdout >>/var/other.txt"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        8 if cfg!(
        ...
        8 if cfg!(talos_boot_scenario = "qemu_local_shell_stdout_close_redirection") => {
            line == b"exec stderr 2>file" && status == UnexpectedArgument && response_lines == 1
        }
        8 if cfg!(talos_boot_scenario = "qemu_local_shell_stderr_close_redirection") => {
            line == b"exec stdout 1>&-" && status == Handled && response_lines == 11
        }
        ...
        9 if cfg!(talos_boot_scenario = "qemu_local_shell_waitpid_any_completed_child") => {
            line == b"waitpid" && status == Handled && response_lines == 1
        }
        9 if cfg!(talos_boot_scenario = "qemu_local_shell_vfs_exec") => {
            line == b"exec /missing" && status == UnexpectedArgument && response_lines == 1
        }
        9 if cfg!(talos_boot_scenario = "qemu_local_shell_literal_argv") => {
            line == b"exec /missing" && status == UnexpectedArgument && response_lines == 1
        }
        9 if cfg!(talos_boot_scenario = "qemu_local_shell_path_lookup") => {
            line == b"laststatus" && status == Handled && response_lines == 1
        }
        9 if cfg!(talos_boot_scenario = "qemu_local_shell_stdout") => {
            line == b"exec zero" && status == Handled && response_lines == 10
        }
        9 if cfg!(talos_boot_scenario = "qemu_local_shell_stdout_to_stderr_redirection") => {
            line == b"exec stdout 1>file" && status == UnexpectedArgument && response_lines == 1
        }
        9 if cfg!(talos_boot_scenario = "qemu_local_shell_dev_null_stdout_redirection") => {
            line == b"exec stdout 1>file" && status == UnexpectedArgument && response_lines == 1
        }
        9 if cfg!(talos_boot_scenario = "qemu_local_shell_dev_null_stderr_redirection") => {
            line == b"exec stderr 2>file" && status == UnexpectedArgument && response_lines == 1
        }
        9 if cfg!(talos_boot_scenario = "qemu_local_shell_dev_null_stdin_redirection") => {
            line == b"exec stdin </etc/missing.txt"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        9 if cfg!(
        ...
        9 if cfg!(talos_boot_scenario = "qemu_local_shell_stdout_regular_file_redirection") => {
            line == b"exec stdout >>/var/other.txt"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        ...
        9 if cfg!(talos_boot_scenario = "qemu_local_shell_stdout_close_redirection") => {
            line == b"exec stdout 1>file" && status == UnexpectedArgument && response_lines == 1
        }
        9 if cfg!(talos_boot_scenario = "qemu_local_shell_stderr_close_redirection") => {
            line == b"waitpid" && status == Handled && response_lines == 1
        }
        ...
        10 if cfg!(talos_boot_scenario = "qemu_local_shell_waitpid_any_completed_child") => {
            line == b"waitpid 0x100001" && status == Handled && response_lines == 1
        }
        10 if cfg!(talos_boot_scenario = "qemu_local_shell_vfs_exec") => {
            line == b"exec bin/init" && status == UnexpectedArgument && response_lines == 1
        }
        10 if cfg!(talos_boot_scenario = "qemu_local_shell_literal_argv") => {
            line == b"exec bin/init" && status == UnexpectedArgument && response_lines == 1
        }
        10 if cfg!(talos_boot_scenario = "qemu_local_shell_path_lookup") => {
            line == b"exec missing" && status == UnexpectedArgument && response_lines == 1
        }
        10 if cfg!(talos_boot_scenario = "qemu_local_shell_stdout") => {
            line == b"exec /bin/status42 gamma" && status == Handled && response_lines == 10
        }
        10 if cfg!(talos_boot_scenario = "qemu_local_shell_stdout_to_stderr_redirection") => {
            line == b"exec stdout | stderr" && status == UnexpectedArgument && response_lines == 1
        }
        10 if cfg!(talos_boot_scenario = "qemu_local_shell_dev_null_stdout_redirection") => {
            line == b"exec stdout | stderr" && status == UnexpectedArgument && response_lines == 1
        }
        10 if cfg!(talos_boot_scenario = "qemu_local_shell_dev_null_stderr_redirection") => {
            line == b"exec stderr 2>>/dev/null"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        10 if cfg!(talos_boot_scenario = "qemu_local_shell_dev_null_stdin_redirection") => {
            line == b"exec stdin < /dev/null" && status == UnexpectedArgument && response_lines == 1
        }
        10 if cfg!(
            talos_boot_scenario = "qemu_local_shell_readonly_regular_file_stdin_redirection"
        ) =>
        {
            line == b"exec stdin < /etc/banner.txt"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        10 if cfg!(talos_boot_scenario = "qemu_local_shell_stdout_regular_file_redirection") => {
            line == b"exec stdout >/var/other.txt"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        ...
        10 if cfg!(talos_boot_scenario = "qemu_local_shell_stderr_regular_file_redirection") => {
            line == b"/bin/stderr 2>>/tmp/stderr.txt" && status == Handled && response_lines == 11
        }
        10 if cfg!(
            talos_boot_scenario = "qemu_local_shell_stderr_regular_file_append_redirection"
        ) =>
        ...
        10 if cfg!(talos_boot_scenario = "qemu_local_shell_stdout_close_redirection") => {
            line == b"exec stdout | stderr" && status == UnexpectedArgument && response_lines == 1
        }
        10 if cfg!(talos_boot_scenario = "qemu_local_shell_stderr_close_redirection") => {
            line == b"exec stderr 2>file" && status == UnexpectedArgument && response_lines == 1
        }
        ...
        11 if cfg!(talos_boot_scenario = "qemu_local_shell_waitpid_any_completed_child") => {
            line == b"waitpid 0x100002" && status == Handled && response_lines == 1
        }
        11 if cfg!(talos_boot_scenario = "qemu_local_shell_vfs_exec") => {
            line == b"exec /bin" && status == UnexpectedArgument && response_lines == 1
        }
        11 if cfg!(talos_boot_scenario = "qemu_local_shell_literal_argv") => {
            line == b"cat /etc/banner.txt" && status == Handled && response_lines == 1
        }
        11 if cfg!(talos_boot_scenario = "qemu_local_shell_path_lookup") => {
            line == b"exec bin/status42" && status == UnexpectedArgument && response_lines == 1
        }
        11 if cfg!(talos_boot_scenario = "qemu_local_shell_stdout") => {
            line == b"exec missing" && status == UnexpectedArgument && response_lines == 1
        }
        11 if cfg!(talos_boot_scenario = "qemu_local_shell_stdout_to_stderr_redirection") => {
            line == b"cat /etc/banner.txt" && status == Handled && response_lines == 1
        }
        11 if cfg!(talos_boot_scenario = "qemu_local_shell_dev_null_stdout_redirection") => {
            line == b"cat /etc/banner.txt" && status == Handled && response_lines == 1
        }
        11 if cfg!(talos_boot_scenario = "qemu_local_shell_dev_null_stderr_redirection") => {
            line == b"exec stderr </dev/null" && status == UnexpectedArgument && response_lines == 1
        }
        11 if cfg!(talos_boot_scenario = "qemu_local_shell_dev_null_stdin_redirection") => {
            line == b"cat /etc/banner.txt" && status == Handled && response_lines == 1
        }
        11 if cfg!(
            talos_boot_scenario = "qemu_local_shell_readonly_regular_file_stdin_redirection"
        ...
        11 if cfg!(talos_boot_scenario = "qemu_local_shell_stdout_regular_file_redirection") => {
            line == b"exec stderr 2>/tmp/stdout.txt"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        ...
        {
            line == b"/bin/stdout >>/var/other.txt"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        11 if cfg!(
        ...
        11 if cfg!(talos_boot_scenario = "qemu_local_shell_stderr_regular_file_redirection") => {
            line == b"/bin/stderr 2> /tmp/stderr.txt"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        ...
        11 if cfg!(talos_boot_scenario = "qemu_local_shell_stdout_close_redirection") => {
            line == b"cat /etc/banner.txt" && status == Handled && response_lines == 1
        }
        11 if cfg!(talos_boot_scenario = "qemu_local_shell_stderr_close_redirection") => {
            line == b"cat /etc/banner.txt" && status == Handled && response_lines == 1
        }
        ...
        12 if cfg!(talos_boot_scenario = "qemu_local_shell_waitpid_any_completed_child") => {
            line == b"exec /bin/status42 &" && status == Handled && response_lines == 8
        }
        ...
        12 if cfg!(talos_boot_scenario = "qemu_local_shell_waitpid") => {
            line == b"exec /missing" && status == UnexpectedArgument && response_lines == 1
        }
        12 if cfg!(talos_boot_scenario = "qemu_local_shell_path_lookup") => {
            line == b"exec /bin" && status == UnexpectedArgument && response_lines == 1
        }
        12 if cfg!(talos_boot_scenario = "qemu_local_shell_dev_null_stderr_redirection") => {
            line == b"cat /etc/banner.txt" && status == Handled && response_lines == 1
        }
        12 if cfg!(talos_boot_scenario = "qemu_local_shell_stdout_regular_file_redirection") => {
            line == b"cat /etc/banner.txt" && status == Handled && response_lines == 1
        }
        12 if cfg!(
            talos_boot_scenario = "qemu_local_shell_direct_stdout_regular_file_append_redirection"
        ...
        {
            line == b"exec stdout 3>/tmp/stdout.txt"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        13 if cfg!(any(
        ...
        {
            line == b"exec stdout 1>/var/other.txt"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        12 if cfg!(talos_boot_scenario = "qemu_local_shell_stderr_regular_file_redirection") => {
            line == b"exec stdout >/tmp/stderr.txt"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        ...
        {
            line == b"exec stdout >>/tmp/stdout.txt"
                && status == UnexpectedArgument
                && response_lines == 1
        }
        13 if cfg!(talos_boot_scenario = "qemu_local_shell_stderr_regular_file_redirection") => {
            line == b"cat /etc/banner.txt" && status == Handled && response_lines == 1
        }
        13 if cfg!(
            talos_boot_scenario = "qemu_local_shell_stderr_regular_file_append_redirection"
        ...
        12 if cfg!(talos_boot_scenario = "qemu_local_shell_stdout") => {
            line == b"exec bin/status42" && status == UnexpectedArgument && response_lines == 1
        }
        ...
        13 if cfg!(talos_boot_scenario = "qemu_local_shell_waitpid_any_completed_child") => {
            line == b"waitpid" && status == Handled && response_lines == 2
        }
        13 if cfg!(talos_boot_scenario = "qemu_local_shell_vfs_exec") => {
            line == b"exec /empty" && status == UnexpectedArgument && response_lines == 1
        }
        13 if cfg!(talos_boot_scenario = "qemu_local_shell_waitpid") => {
            line == b"exec bin/init" && status == UnexpectedArgument && response_lines == 1
        }
        13 if cfg!(talos_boot_scenario = "qemu_local_shell_path_lookup") => {
            line == b"exec /etc/banner.txt" && status == UnexpectedArgument && response_lines == 1
        }
        13 if cfg!(talos_boot_scenario = "qemu_local_shell_stdout") => {
            line == b"exec /bin" && status == UnexpectedArgument && response_lines == 1
        }
        ...
        14 if cfg!(talos_boot_scenario = "qemu_local_shell_waitpid_any_completed_child") => {
            line == b"jobs" && status == Handled && response_lines == 1
        }
        14 if cfg!(talos_boot_scenario = "qemu_local_shell_vfs_exec") => {
            line == b"cat /etc/banner.txt" && status == Handled && response_lines == 1
        }
        14 if cfg!(talos_boot_scenario = "qemu_local_shell_waitpid") => {
            line == b"exec /bin" && status == UnexpectedArgument && response_lines == 1
        }
        14 if cfg!(talos_boot_scenario = "qemu_local_shell_path_lookup") => {
            line == b"exec /empty" && status == UnexpectedArgument && response_lines == 1
        }
        14 if cfg!(talos_boot_scenario = "qemu_local_shell_stdout") => {
            line == b"exec /etc/banner.txt" && status == UnexpectedArgument && response_lines == 1
        }
        ...
        15 if cfg!(talos_boot_scenario = "qemu_local_shell_waitpid_any_completed_child") => {
            line == b"exec /bin/zero &" && status == Handled && response_lines == 8
        }
        15 if cfg!(talos_boot_scenario = "qemu_local_shell_waitpid") => {
            line == b"exec /etc/banner.txt" && status == UnexpectedArgument && response_lines == 1
        }
        15 if cfg!(talos_boot_scenario = "qemu_local_shell_path_lookup") => {
            line == b"exec /bin/status42 *" && status == UnexpectedArgument && response_lines == 1
        }
        15 if cfg!(talos_boot_scenario = "qemu_local_shell_stdout") => {
            line == b"exec /empty" && status == UnexpectedArgument && response_lines == 1
        }
        ...
        16 if cfg!(talos_boot_scenario = "qemu_local_shell_waitpid_any_completed_child") => {
            line == b"cat /etc/banner.txt" && status == Handled && response_lines == 2
        }
        16 if cfg!(talos_boot_scenario = "qemu_local_shell_waitpid") => {
            line == b"exec /empty" && status == UnexpectedArgument && response_lines == 1
        }
        16 if cfg!(talos_boot_scenario = "qemu_local_shell_path_lookup") => {
            line == b"cat /etc/banner.txt" && status == Handled && response_lines == 1
        }
        16 if cfg!(talos_boot_scenario = "qemu_local_shell_stdout") => {
            line == b"exec /bin/status42 *" && status == UnexpectedArgument && response_lines == 1
        }
        ...
        17 if cfg!(talos_boot_scenario = "qemu_local_shell_waitpid_any_completed_child") => {
            line == b"jobs" && status == Handled && response_lines == 1
        }
        17 if cfg!(talos_boot_scenario = "qemu_local_shell_waitpid") => {
            line == b"cat /etc/banner.txt" && status == Handled && response_lines == 1
        }
        18 if cfg!(talos_boot_scenario = "qemu_local_shell_waitpid_any_completed_child") => {
            line == b"jobs" && status == Handled && response_lines == 1
        }
