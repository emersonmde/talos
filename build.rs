...
const RPI5_PRE_RUST_ENTRY_LOOP_ASM: &str = "TALOS_RPI5_PRE_RUST_ENTRY_LOOP_SCENARIO";
...
const BOOT_SCENARIOS: &[BootScenario] = &[
    ...
    BootScenario {
        value: "rpi5_rp1_ethernet_bcm54213pe_readonly_preflight_v2_candidate",
        implied_values: &[],
        asm_defines: &[],
    },
    BootScenario {
        value: "rpi5_rp1_ethernet_bcm54213pe_readonly_preflight_v2_no_mdio_control",
        implied_values: &[],
        asm_defines: &[],
    },
    BootScenario {
    ...
    BootScenario {
        value: "rpi5_rp1_ethernet_bcm54213pe_autoneg_convergence_candidate",
        implied_values: &[],
        asm_defines: &[],
    },
    BootScenario {
        value: "rpi5_rp1_ethernet_bcm54213pe_autoneg_convergence_no_mdio_control",
        implied_values: &[],
        asm_defines: &[],
    },
    BootScenario {
        value: "rpi5_rp1_ethernet_bcm54213pe_rgmii_delay_candidate",
        implied_values: &[],
        asm_defines: &[],
    },
    BootScenario {
        value: "rpi5_rp1_ethernet_bcm54213pe_rgmii_delay_no_mdio_control",
        implied_values: &[],
        asm_defines: &[],
    },
    BootScenario {
    ...
    BootScenario {
        value: "rpi5_rp1_ethernet_bcm54213pe_master_mode_autoneg_candidate",
        implied_values: &[],
        asm_defines: &[],
    },
    BootScenario {
        value: "rpi5_rp1_ethernet_bcm54213pe_master_mode_autoneg_no_mdio_control",
        implied_values: &[],
        asm_defines: &[],
    },
    BootScenario {
    ...
    BootScenario {
        value: "rpi5_ssh_service_smoltcp_pre_rust_marker_loop",
        implied_values: &["rpi5_ssh_service_smoltcp_runtime_ready"],
        asm_defines: &[RPI5_PRE_RUST_ENTRY_LOOP_ASM],
    },
    BootScenario {
        value: "rpi5_ssh_service_smoltcp_rust_entry_marker_loop",
        implied_values: &["rpi5_ssh_service_smoltcp_runtime_ready"],
        asm_defines: &[RPI5_EARLY_ENTRY_PROVENANCE_ASM],
    },
    BootScenario {
    ...
    BootScenario {
        value: "rpi5_ssh_service_smoltcp_target_init_marker_loop",
        implied_values: &["rpi5_ssh_service_smoltcp_runtime_ready"],
        asm_defines: &[RPI5_EARLY_ENTRY_PROVENANCE_ASM],
    },
    BootScenario {
        value: "rpi5_ssh_service_smoltcp_exceptions_ready_marker_loop",
        implied_values: &["rpi5_ssh_service_smoltcp_runtime_ready"],
        asm_defines: &[RPI5_EARLY_ENTRY_PROVENANCE_ASM],
    },
    BootScenario {
        value: "rpi5_ssh_service_smoltcp_kernel_main_marker_loop",
        implied_values: &["rpi5_ssh_service_smoltcp_runtime_ready"],
        asm_defines: &[RPI5_EARLY_ENTRY_PROVENANCE_ASM],
    },
    BootScenario {
        value: "rpi5_ssh_service_smoltcp_route_start_marker_loop",
        implied_values: &["rpi5_ssh_service_smoltcp_runtime_ready"],
        asm_defines: &[RPI5_EARLY_ENTRY_PROVENANCE_ASM],
    },
    BootScenario {
    ...
    BootScenario {
        ...
        implied_values: &[],
        asm_defines: &[RPI5_HANDOFF_SENTINEL_ASM],
    },
    BootScenario {
        value: "rpi5_selected_image_boot_contract_discriminator",
        implied_values: &[],
        asm_defines: &[RPI5_BOOT_CONTRACT_DISCRIMINATOR_ASM],
    },
    BootScenario {
    ...
    BootScenario {
        value: "rpi5_rp1_ethernet_bootinfo_report_serial_visibility_earliest_only_control",
        implied_values: &[],
        asm_defines: &[],
    },
    BootScenario {
    ...
    BootScenario {
        value: "qemu_local_shell_bare_name_command_argv",
        implied_values: &["qemu_local_serial_command_loop"],
        asm_defines: &[],
    },
    BootScenario {
        value: "qemu_local_shell_absolute_path_vfs_pipeline",
        implied_values: &["qemu_local_serial_command_loop"],
        asm_defines: &[],
    },
    BootScenario {
        value: "qemu_local_shell_direct_pipeline_stage_argv",
        implied_values: &["qemu_local_serial_command_loop"],
        asm_defines: &[],
    },
    BootScenario {
        value: "qemu_local_shell_direct_pipeline_stdin_redirection",
        implied_values: &["qemu_local_serial_command_loop"],
        asm_defines: &[],
    },
    BootScenario {
        value: "qemu_local_shell_direct_pipeline_consumer_stdin_redirection",
        implied_values: &["qemu_local_serial_command_loop"],
        asm_defines: &[],
    },
    BootScenario {
        value: "qemu_local_shell_direct_combined_pipeline_stdin_stdout_redirection",
        implied_values: &["qemu_local_serial_command_loop"],
        asm_defines: &[],
    },
    BootScenario {
        value: "qemu_local_shell_direct_combined_pipeline_stdout_append_redirection",
        implied_values: &["qemu_local_serial_command_loop"],
        asm_defines: &[],
    },
    BootScenario {
        value: "qemu_local_shell_direct_combined_pipeline_stderr_regular_file_redirection",
        implied_values: &["qemu_local_serial_command_loop"],
        asm_defines: &[],
    },
    BootScenario {
        value: "qemu_local_shell_direct_combined_pipeline_stderr_append_redirection",
        implied_values: &["qemu_local_serial_command_loop"],
        asm_defines: &[],
    },
    BootScenario {
        value: "qemu_local_shell_bare_name_combined_pipeline_stderr_append_redirection",
        implied_values: &["qemu_local_serial_command_loop"],
        asm_defines: &[],
    },
    BootScenario {
        value: "qemu_local_shell_bare_name_combined_pipeline_stdout_append_redirection",
        implied_values: &["qemu_local_serial_command_loop"],
        asm_defines: &[],
    },
    BootScenario {
        value: "qemu_local_shell_bare_name_combined_pipeline_stderr_regular_file_redirection",
        implied_values: &["qemu_local_serial_command_loop"],
        asm_defines: &[],
    },
    BootScenario {
        value: "qemu_local_shell_bare_name_combined_pipeline_stdin_stdout_redirection",
        implied_values: &["qemu_local_serial_command_loop"],
        asm_defines: &[],
    },
    BootScenario {
        value: "qemu_local_shell_bare_name_pipeline_stdin_redirection",
        implied_values: &["qemu_local_serial_command_loop"],
        asm_defines: &[],
    },
    BootScenario {
        value: "qemu_local_shell_bare_name_pipeline_consumer_stdin_redirection",
        implied_values: &["qemu_local_serial_command_loop"],
        asm_defines: &[],
    },
    BootScenario {
        value: "qemu_local_shell_bare_name_pipeline_stage_argv",
        implied_values: &["qemu_local_serial_command_loop"],
        asm_defines: &[],
    },
    BootScenario {
        value: "qemu_local_shell_bare_name_vfs_pipeline",
        implied_values: &["qemu_local_serial_command_loop"],
        asm_defines: &[],
    },
    BootScenario {
    ...
    BootScenario {
        value: "qemu_local_shell_direct_stdin_redirection",
        implied_values: &["qemu_local_serial_command_loop"],
        asm_defines: &[],
    },
    BootScenario {
        value: "qemu_local_shell_direct_combined_stdin_stdout_redirection",
        implied_values: &["qemu_local_serial_command_loop"],
        asm_defines: &[],
    },
    BootScenario {
        value: "qemu_local_shell_bare_name_combined_stdin_stdout_redirection",
        implied_values: &["qemu_local_serial_command_loop"],
        asm_defines: &[],
    },
    BootScenario {
        value: "qemu_local_shell_bare_name_stdin_redirection",
        implied_values: &["qemu_local_serial_command_loop"],
        asm_defines: &[],
    },
    BootScenario {
    ...
    BootScenario {
        value: "qemu_local_shell_bare_name_stdout_regular_file_redirection",
        implied_values: &["qemu_local_serial_command_loop"],
        asm_defines: &[],
    },
    BootScenario {
        value: "qemu_local_shell_direct_stdout_regular_file_append_redirection",
        implied_values: &["qemu_local_serial_command_loop"],
        asm_defines: &[],
    },
    BootScenario {
        value: "qemu_local_shell_bare_name_stdout_regular_file_append_redirection",
        implied_values: &["qemu_local_serial_command_loop"],
        asm_defines: &[],
    },
    BootScenario {
    ...
    BootScenario {
        value: "qemu_local_shell_direct_pipeline_output_append_regular_file_redirection",
        implied_values: &["qemu_local_serial_command_loop"],
        asm_defines: &[],
    },
    BootScenario {
        value: "qemu_local_shell_bare_name_pipeline_output_append_regular_file_redirection",
        implied_values: &["qemu_local_serial_command_loop"],
        asm_defines: &[],
    },
    BootScenario {
        value: "qemu_local_shell_direct_pipeline_stderr_regular_file_redirection",
        implied_values: &["qemu_local_serial_command_loop"],
        asm_defines: &[],
    },
    BootScenario {
        value: "qemu_local_shell_bare_name_pipeline_stderr_regular_file_redirection",
        implied_values: &["qemu_local_serial_command_loop"],
        asm_defines: &[],
    },
    BootScenario {
    ...
    BootScenario {
        value: "qemu_local_shell_direct_stderr_regular_file_append_redirection",
        implied_values: &["qemu_local_serial_command_loop"],
        asm_defines: &[],
    },
    BootScenario {
        value: "qemu_local_shell_bare_name_stderr_regular_file_append_redirection",
        implied_values: &["qemu_local_serial_command_loop"],
        asm_defines: &[],
    },
    BootScenario {
    ...
    BootScenario {
        value: "qemu_local_shell_multistage_pipeline",
        implied_values: &["qemu_local_serial_command_loop"],
        asm_defines: &[],
    },
    BootScenario {
        value: "qemu_local_shell_pipeline_status",
        implied_values: &["qemu_local_serial_command_loop"],
        asm_defines: &[],
    },
    BootScenario {
    ...
    BootScenario {
        value: "qemu_local_shell_waitpid_any_completed_child",
        implied_values: &["qemu_local_serial_command_loop"],
        asm_defines: &[],
    },
    BootScenario {
        value: "qemu_local_shell_process_status_vfs",
        implied_values: &["qemu_local_serial_command_loop"],
        asm_defines: &[],
    },
    BootScenario {
        value: "qemu_local_shell_ps_command_vfs",
        implied_values: &["qemu_local_serial_command_loop"],
        asm_defines: &[],
    },
    BootScenario {
