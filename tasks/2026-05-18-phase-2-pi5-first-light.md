...
- The remaining productive path is EEPROM/kernel-handoff diagnostics, a known-good Pi OS Lite source-tree snapshot for byte-level comparison, or a lower-level proof of where the firmware jumps after loading `armstub8-2712.bin` and `kernel_2712.img`.
