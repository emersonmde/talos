...
- The remaining productive path is a loader/handoff diagnostic with a different observable side effect than UART, deeper comparison with public Pi 5 boot references, or a controlled strategy shift such as a Linux-loaded payload if direct firmware handoff remains opaque after bounded diagnostics.
