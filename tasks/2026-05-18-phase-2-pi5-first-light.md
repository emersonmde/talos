...
- Run one controlled combined prefix-plus-armstub diagnostic. If it still stops at the same boundary, the remaining productive path is lab-side TFTP request visibility or EEPROM boot diagnostics rather than more archive-shape variants.
